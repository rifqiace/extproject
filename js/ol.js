...
(function (root, factory) {
  ...
  function pa(a) {
    this.message =
      "Assertion failed. See https://openlayers.org/en/v4.0.1/doc/errors/#" +
      a +
      " for details.";
    this.code = a;
  ...
  function Ha(a) {
    for (var b = Ia(), c = 0, d = a.length; c < d; ++c) Ja(b, a[c]);
    return b;
  }
  function Ka(a, b, c) {
    return c
...
*/
  ...
  function Eb(a, b, c) {
    ...
    d
      ...
      : "degrees" != a.Jb() &&
        ...
        (b = d(b, b, 2)),
        (b =
          (ub.b(b.slice(0, 2), b.slice(2, 4)) +
            ub.b(b.slice(4, 6), b.slice(6, 8))) /
          2),
        (a = a.sc()),
        void 0 !== a && (b /= a));
    return b;
    ...
    if (!e) {
      ...
      if ("function" == typeof f) {
        ...
        void 0 !== g &&
          ...
          (g === h
            ? Hb([b, a])
            : ((e = f(d, c)), Rb(b, a, e.forward, e.inverse)),
          (e = Db(c, d)));
      }
    }
    e || (e = Vb);
  ...
  function $b(a) {
    ...
    this.c = null;
    void 0 !== a.origins &&
      ((this.c = a.origins), qa(this.c.length == this.b.length, 20));
    var b = a.extent;
    void 0 === b || this.f || this.c || (this.f = eb(b));
    qa((!this.f && this.c) || (this.f && !this.c), 18);
    this.i = null;
    void 0 !== a.tileSizes &&
      ((this.i = a.tileSizes), qa(this.i.length == this.b.length, 19));
  ...
  k.eh = function (a, b, c) {
    ...
    for (var d = a.da, e = a.ba; d <= e; ++d)
      for (var f = a.fa, g = a.ja; f <= g; ++f) c([b, d, f]);
  };
  function ec(a, b, c, d, e) {
    e = a.Ta(b, e);
    for (b = b[0] - 1; b >= a.minZoom; ) {
      if (c.call(null, b, cc(a, e, b, d))) return !0;
      --b;
    }
    return !1;
  }
  ...
  function oc(a) {
    return function (b) {
      if (b) return [wa(b[0], a[0], a[2]), wa(b[1], a[1], a[3])];
    };
  }
  function pc(a) {
    return a;
  ...
  function vc(a, b) {
    ...
    if (c) {
      ...
      c.length = 0;
      if ((c = a.eb)) delete c[b], Object.keys(c).length || delete a.eb;
    }
  }
  function B(a, b, c, d, e) {
    ...
    (f = sc(g, c, d, !1))
      ? e || (f.Xg = !1)
      : ((f = { Vg: d, Xg: !!e, listener: c, target: a, type: b }),
        a.addEventListener(b, qc(f)),
        g.push(f));
    return f;
  }
  function wc(a, b, c, d) {
  ...
  Dc.prototype.b = function (a) {
    ...
    if (c) {
      ...
      if (!this.ta[a]) {
        b = this.$a[a];
        for (delete this.$a[a]; b--; ) this.removeEventListener(a, na);
        delete this.ta[a];
      }
      return d;
    }
  ...
  Dc.prototype.removeEventListener = function (a, b) {
    ...
    if (c) {
      ...
      a in this.$a
        ? ((c[d] = na), ++this.$a[a])
        : (c.splice(d, 1), c.length || delete this.qa[a]);
    }
  };
  function Fc() {
    Dc.call(this);
  ...
  k.K = function (a, b, c) {
    if (Array.isArray(a))
      for (var d = 0, e = a.length; d < e; ++d) xc(this, a[d], b, c);
    else xc(this, a, b, c);
  };
  function Gc(a) {
    Fc.call(this);
  ...
  k.set = function (a, b, c) {
    c
      ? (this.I[a] = b)
      : ((c = this.I[a]), (this.I[a] = b), c !== b && Jc(this, a, c));
  };
  k.H = function (a, b) {
  ...
  k.remove = function (a) {
    var b = this.a,
      ...
      d;
    c = 0;
    for (d = b.length; c < d; ++c) if (b[c] === a) return this.tg(c);
  };
  k.tg = function (a) {
    var b = this.a[a];
    this.a.splice(a, 1);
  ...
  k.mp = function (a, b) {
    ...
    if (a < c)
      (c = this.a[a]),
        (this.a[a] = b),
        this.b(new Nc("remove", c)),
        this.b(new Nc("add", b));
    else {
      for (; c < a; ++c) this.Be(c, void 0);
      this.Be(a, b);
    }
  };
  function Lc(a) {
      ...
      if (a.hasOwnProperty(c)) d = a[c];
        ...
        if (Oc.exec(d)) {
          ...
          d.indexOf("rgba(")
            ? d.indexOf("rgb(")
              ? qa(!1, 14)
              : ((d = d.slice(4, -1).split(",").map(Number)),
                d.push(1),
                (f = Uc(d)))
            : ((d = d.slice(5, -1).split(",").map(Number)), (f = Uc(d)));
        d = f;
        a[c] = d;
        ++b;
      }
  ...
  ad.prototype.setMap = function (a) {
    ...
    for (var b = 0, c = this.v.length; b < c; ++b) rc(this.v[b]);
    this.v.length = 0;
    if ((this.a = a))
      (this.S ? this.S : a.u).appendChild(this.element),
        this.render !== na &&
  ...
  function bd(a) {
    ...
    c.className =
      ...
      (this.c && this.j ? " ol-collapsed" : "") +
      (this.j ? "" : " ol-uncollapsible");
  ...
  function cd(a) {
    if ((a = a.frameState)) {
                          ...
                          for (A = Pa.a[n].length; V < A; ++V) {
                            ...
                            if (z.da < Ma.da || z.ba > Ma.ba)
                              if (
                                va(
                                  C,
                                  new sa(Ca(z.da, xb), Ca(z.ba, xb), z.fa, z.ja)
                                ) ||
                                (z.ba - z.da + 1 > xb && va(C, Ma))
                              ) {
                                n = !0;
                                break a;
                              }
      ...
      for (var Z in this.o)
        Z in c
          ? (this.l[Z] || ((this.o[Z].style.display = ""), (this.l[Z] = !0)),
            delete c[Z])
          : Z in b
          ? (this.l[Z] &&
              ((this.o[Z].style.display = "none"), delete this.l[Z]),
            delete b[Z])
          : (Zc(this.o[Z]), delete this.o[Z], delete this.l[Z]);
      for (Z in c)
      ...
      this.G != Z &&
        ((this.element.style.display = Z ? "" : "none"), (this.G = Z));
      Z && sb(this.l)
      ...
      a = a.logos;
      Z = this.Y;
      for (Ra in Z) Ra in a || (Zc(Z[Ra]), delete Z[Ra]);
      for (var Cb in a)
        (b = a[Cb]),
          b instanceof HTMLElement && (this.u.appendChild(b), (Z[Cb] = b)),
          Cb in Z ||
            ((Ra = new Image()),
            (Ra.src = Cb),
            "" === b
  ...
  function id(a) {
    ...
    "string" === typeof c
      ...
      : ((this.c = c), this.c.classList.add("ol-compass"));
    ...
    ad.call(this, { element: d, render: b, target: a.target });
  ...
  id.prototype.A = function (a) {
    ...
    if (this.j) this.j();
      ...
      void 0 !== b &&
        (0 < this.o
          ? ((b %= 2 * Math.PI),
            a.animate({ rotation: 0, duration: this.o, easing: fd }))
          : a.He(0));
    }
  };
  function jd(a) {
    if ((a = a.frameState)) {
      ...
      if (a != this.u) {
        ...
        if (this.l) {
          ...
          c || a
            ? c && a && this.element.classList.remove("ol-hidden")
  ...
  function kd(a) {
    ...
    c.appendChild(h);
    c.appendChild(d);
    ad.call(this, { element: c, target: a.target });
  ...
  kd.prototype.l = function (a, b) {
    ...
    if (c) {
      ...
      d &&
        ...
        0 < this.c
          ? (0 < ld(c)[0] && md(c),
            c.animate({ resolution: d, duration: this.c, easing: fd }))
          : c.Xc(d));
    }
  };
  function nd(a) {
    ...
    (void 0 !== a.attribution ? a.attribution : 1) &&
      b.push(new bd(a.attributionOptions));
    return b;
  }
  function od(a) {
    a = a ? a : {};
    ...
    c = document.createElement("div");
    c.className =
      this.c + " ol-unselectable ol-control " + (qd() ? "" : "ol-unsupported");
    c.appendChild(b);
    ad.call(this, { element: c, target: a.target });
  ...
  od.prototype.C = function (a) {
    ...
    qd() &&
      ...
      (pd()
        ...
        : ((a = this.l
            ? "string" === typeof this.l
              ? document.getElementById(this.l)
              : this.l
            : a.Kc()),
          this.A
  ...
  od.prototype.u = function () {
    var a = this.element.firstElementChild,
      b = this.a;
    pd()
      ? ((a.className = this.c + "-true"), Yc(this.o, this.j))
      : ((a.className = this.c + "-false"), Yc(this.j, this.o));
    b && b.xd();
  };
  ...
  function ud(a) {
    ...
    a
      ? this.c != a.viewState.projection &&
        ((this.c = a.viewState.projection), (this.l = null))
      : (this.c = null);
    wd(this, this.j);
  }
  k = td.prototype;
  ...
  k.setMap = function (a) {
    ...
    a &&
      ((a = a.c),
      this.v.push(
        B(a, "mousemove", this.rl, this),
        B(a, "mouseout", this.sl, this)
      ));
  };
  k.Fi = function (a) {
    this.set(xd, a);
  ...
  function wd(a, b) {
    ...
    if (b && a.c) {
      ...
      if ((d = a.a.Za(b))) a.l(d, d), (c = (c = a.ih()) ? c(d) : d.toString());
    }
  ...
  function Dd(a, b) {
    ...
    for (d = 0; d < e; ++d)
      try {
        if ((c = a.getContext(Cd[d], b))) return c;
      } catch (f) {}
    return null;
  }
  var Ed,
  ...
  if ("WebGLRenderingContext" in window)
    try {
      var Vd = Dd(document.createElement("CANVAS"), {
        failIfMajorPerformanceCaveat: !0,
      });
      Vd &&
        ((Sd = !0),
        (Td = Vd.getParameter(Vd.MAX_TEXTURE_SIZE)),
        (Ud = Vd.getSupportedExtensions()));
    } catch (a) {}
  Ed = Sd;
  ca = Ud;
  ba = Td;
  ...
  function Yd(a, b) {
    for (
      var c = a.f, d = b.clientX, e = b.clientY, f = 0, g = c.length, h;
      f < g && (h = c[f]);
      f++
    ) {
  ...
  function fe(a, b) {
    ...
    "number" === typeof b.pointerType &&
      ((c = ae(b, b)), (c.pointerType = a.f[b.pointerType]));
    return c;
  }
  k = ee.prototype;
  k.Vl = function (a) {
  ...
  k.so = function (a, b) {
    this.a[b.pointerId] = { target: b.target, out: b, pi: b.target };
    var c = this.b;
    b.bubbles = !0;
  ...
  k.Rl = function (a, b) {
    ...
    if (c) {
      ...
      d &&
        ...
        (d.target = e),
        b.target
          ? (de(this.b, d, a), ce(this.b, b, a))
          : ((b.target = e), (b.relatedTarget = null), this.zf(a, b)));
      c.out = b;
      c.pi = b.target;
    }
  };
  ...
  k.Ep = function (a, b) {
    ...
    b.isPrimary &&
      ((this.f = void 0), (this.c = setTimeout(this.Di.bind(this), 200)));
  };
  k.Ap = function (a) {
    oe(this, a, this.zf);
  };
  ...
  function re(a) {
    ...
    Qd
      ...
      : Rd
      ? se(this, new ee(this))
      : ((a = new Xd(this)), se(this, a), Pd && se(this, new me(this, a)));
    a = this.a.length;
    for (var b, c = 0; c < a; c++) (b = this.a[c]), te(this, Object.keys(b.i));
  }
  u(re, Dc);
  function se(a, b) {
  ...
  function ce(a, b, c) {
    ...
    var d = b.target,
      e = b.relatedTarget;
    (d && e && d.contains(e)) ||
      ((b.bubbles = !1), be(a, "pointerenter", b, c));
  }
  function be(a, b, c, d) {
    a.b(new ge(b, d, c));
  }
  ...
  function ye(a, b) {
    ...
    a.b(c);
    a.l
      ? (clearTimeout(a.l), (a.l = 0), (c = new Bd("dblclick", a.c, b)), a.b(c))
      : (a.l = setTimeout(
          function () {
            this.l = 0;
  ...
  function ze(a, b) {
    "pointerup" == b.type || "pointercancel" == b.type
      ? delete a.I[b.pointerId]
      : "pointerdown" == b.type && (a.I[b.pointerId] = !0);
  ...
  k.ul = function (a) {
    ...
    this.f = a;
    this.i.length ||
      ((this.a = new re(document)),
      this.i.push(
        B(this.a, "pointermove", this.om, this),
        B(this.a, "pointerup", this.vh, this),
        B(this.g, "pointercancel", this.vh, this)
      ));
  };
  k.om = function (a) {
  ...
  k.$o = function (a) {
    this.b(
      new Bd(
        ...
        !(
          !this.f ||
          (a.clientX == this.f.clientX && a.clientY == this.f.clientY)
        )
      )
    );
  };
  ...
  Ae.prototype.i = function (a) {
    ...
    return Infinity != b
      ? (this.b.push(a),
        this.f.push(b),
        (this.a[this.c(a)] = !0),
        De(this, 0, this.b.length - 1),
        !0)
      : !1;
  };
  function Ce(a, b) {
    for (
      var c = a.b, d = a.f, e = c.length, f = c[b], g = d[b], h = b;
      b < e >> 1;
  ...
  function Ee(a) {
    ...
    for (h = 0; h < f; ++h)
      (g = c[h]),
        (l = b(g)),
        Infinity == l ? delete a.a[a.c(g)] : ((d[e] = l), (c[e++] = g));
    c.length = e;
    d.length = e;
    for (b = (a.b.length >> 1) - 1; 0 <= b; b--) Ce(a, b);
  }
  function Fe(a, b) {
    Ae.call(
      this,
  ...
  Fe.prototype.j = function (a) {
    ...
    var b = a.V();
    if (2 === b || 3 === b || 4 === b || 5 === b)
      xc(a, "change", this.j, this),
        (a = a.ib()),
        a in this.g && (delete this.g[a], --this.l),
        this.v();
  };
  function Ge(a, b, c) {
    for (var d = 0, e, f; a.l < b && d < c && 0 < a.b.length; )
      (e = Be(a)[0]),
        (f = e.ib()),
        0 !== e.V() || f in a.g || ((a.g[f] = !0), ++a.l, ++d, e.load());
  }
  function He(a) {
    return function (b, c, d) {
      if (void 0 !== b)
  ...
  k.Qd = function (a) {
    ...
    var c = this.kd(a);
    if (c.ha().length < this.B.length) return (this.i[b] = c);
    this.g = a;
    return this;
  };
  k.kd = function () {
  ...
  k.scale = function (a, b, c) {
    ...
    if ((c = this.ha())) {
      b = c.length;
      for (
        var f = this.sa(), g = c ? c : [], h = e[0], e = e[1], l = 0, m = 0;
        m < b;
        m += f
      ) {
        var p = c[m] - h,
  ...
  function mf(a, b, c, d, e, f, g) {
    ...
    if (m || p)
      if (((f = ((e - h) * m + (f - l) * p) / (m * m + p * p)), 1 < f)) b = c;
        ...
        for (e = 0; e < d; ++e) g[e] = Da(a[b + e], a[c + e], f);
        g.length = d;
        return;
      }
  ...
  function tf(a, b, c, d, e) {
    ...
    var f = 0,
      ...
      h;
    g = 0;
    for (h = c.length; g < h; ++g) (b = sf(a, b, c[g], d)), (e[f++] = b);
    e.length = f;
    return e;
  }
    ...
    for (m = c.length; l < m; ++l) {
      ...
      a: {
        ...
        if (b != r) {
          ...
          do
            if (
              ((n = x * Math.round(q[b] / x)),
              (g = x * Math.round(q[b + 1] / x)),
              (b += v),
              b == r)
            ) {
              y[z++] = n;
          ...
          for (; b < r; ) {
            ...
            if (Pa != n || ra != g) {
              var La = n - A,
                ...
                xb = ra - V;
              (La * xb == C * Ma &&
                ((0 > La && Ma < La) || La == Ma || (0 < La && Ma > La)) &&
                ((0 > C && xb < C) || C == xb || (0 < C && xb > C))) ||
                ((y[z++] = n), (y[z++] = g), (A = n), (V = g));
              n = Pa;
              g = ra;
            }
  ...
  k.Gb = function (a, b, c, d) {
    if (d < Oa(this.D(), a, b)) return d;
    this.c != this.f &&
      ((this.l = Math.sqrt(nf(this.B, 0, this.B.length, this.a, 0))),
      (this.c = this.f));
  ...
  k.pa = function (a, b) {
    a
      ? (jf(this, b, a, 1),
        this.B || (this.B = []),
        (this.B.length = sf(this.B, 0, a, this.a)),
        this.s())
      : zf(this, "XY", null);
  };
  function zf(a, b, c) {
  ...
  function Cf(a, b, c, d, e, f) {
    if (!c.length || !Bf(a, b, c[0], d, e, f)) return !1;
    var g;
    b = 1;
    for (g = c.length; b < g; ++b)
      if (Bf(a, c[b - 1], c[b], d, e, f)) return !1;
    return !0;
  }
  ...
  function Gf(a, b, c, d, e) {
    ...
    b = 1;
    for (f = c.length; b < f; ++b) if (Af(a, c[b - 1], c[b], d, e)) return !1;
    return !0;
  }
  function Hf(a, b, c, d) {
    for (var e = 0, f = a[c - d], g = a[c - d + 1]; b < c; b += d)
  ...
  function Kf(a, b, c, d) {
    var e = 0,
      ...
      g;
    f = 0;
    for (g = b.length; f < g; ++f) e = Jf(a, e, b[f], c, d);
    return e;
  }
  function F(a, b) {
    ff.call(this);
  ...
  k.Gb = function (a, b, c, d) {
    if (d < Oa(this.D(), a, b)) return d;
    this.C != this.f &&
      ((this.G = Math.sqrt(of(this.B, 0, this.c, this.a, 0))),
      (this.C = this.f));
  ...
  k.X = function (a) {
    var b;
    void 0 !== a
      ? ((b = this.fc().slice()), Jf(b, 0, this.c, this.a, a))
      : (b = this.B);
  ...
  k.fc = function () {
    if (this.R != this.f) {
      ...
      If(a, this.c, this.a)
        ? (this.l = a)
        : ((this.l = a.slice()),
          (this.l.length = Jf(this.l, 0, this.c, this.a)));
      this.R = this.f;
    }
    return this.l;
  };
  ...
  function Of(a, b, c) {
    ...
    b = a.ka;
    for (
      var f = new F(null, b), d = e * (d + 1), e = Array(d), g = 0;
      g < d;
      g++
    )
      e[g] = 0;
  ...
  function Qf(a) {
    ...
    if (void 0 !== a.resolutions)
      ...
      e = d.D();
      var h =
          (e ? Math.max(hb(e), ib(e)) : (360 * vb.degrees) / d.sc()) /
          256 /
          Math.pow(2, 0),
        l = h / Math.pow(2, 28);
      d = a.maxResolution;
    ...
    this.j = f;
    (void 0 !== a.enableRotation ? a.enableRotation : 1)
      ? ((f = a.constrainRotation),
        (f =
          void 0 === f || !0 === f
            ? Ne()
            : !1 === f
    ...
    void 0 !== a.resolution
      ...
      : void 0 !== a.zoom &&
        (b.resolution = this.constrainResolution(this.a, a.zoom - this.j));
  ...
  k.animate = function (a) {
    ...
    for (var h = [], l = 0; l < f; ++l) {
      ...
      void 0 !== m.zoom
        ? ((p.hf = d),
          (p.jf = this.constrainResolution(this.a, m.zoom - this.j, 0)),
          (d = p.jf))
        : m.resolution && ((p.hf = d), (p.jf = m.resolution), (d = p.jf));
      ...
      for (var a = Date.now(), b = !1, c = this.c.length - 1; 0 <= c; --c) {
        for (var d = this.c[c], e = !0, f = 0, g = d.length; f < g; ++f) {
          ...
          if (!h.complete) {
            ...
            h.hf &&
              ((l = h.hf + b * (h.jf - h.hf)),
              h.anchor && this.set("center", Sf(this, l, h.anchor)),
              this.set("resolution", l));
            void 0 !== h.Cg &&
              ((b = h.Cg + b * (h.Xi - h.Cg)),
              h.anchor && this.set("center", Tf(this, b, h.anchor)),
              this.set("rotation", b));
            b = !0;
            if (!h.complete) break;
          }
  ...
  function Tf(a, b, c) {
    var d,
      e = a.Ba();
    void 0 !== e &&
      ((d = [e[0] - c[0], e[1] - c[1]]), Ve(d, b - a.Va()), Qe(d, c));
    return d;
  }
  function Sf(a, b, c) {
    var d,
  ...
  k.Ff = function (a, b) {
    ...
    a instanceof ff
      ? "Circle" === a.T()
        ? ((a = a.D()), (e = Nf(a)), e.rotate(this.Va(), jb(a)))
        : (e = a)
      : (qa(Array.isArray(a), 24), qa(!gb(a), 25), (e = Nf(a)));
    ...
    void 0 !== c.minResolution
      ? (l = c.minResolution)
      : void 0 !== c.maxZoom
      ? (l = this.constrainResolution(this.a, c.maxZoom - this.j, 0))
      : (l = 0);
    var m = e.ha(),
      p = this.Va(),
      n = Math.cos(-p),
    ...
    g &&
      ((g = this.constrainResolution(d, 0, 0)),
      !h && g < d && (g = this.constrainResolution(g, -1, 0)),
      (d = g));
    p = -p;
    h = (q + v) / 2 + ((f[1] - f[3]) / 2) * d;
    f = (r + x) / 2 + ((f[0] - f[2]) / 2) * d;
  ...
  function bg(a, b, c, d) {
    if (void 0 !== b) {
      var e = a.Va(),
        f = a.Ba();
      void 0 !== e && f && 0 < d
        ? a.animate({ rotation: b, anchor: c, duration: d, easing: fd })
        : a.rotate(b, c);
    }
  }
  function cg(a, b, c, d) {
  ...
  function dg(a, b, c, d) {
    if (b) {
      var e = a.Ua(),
        f = a.Ba();
      void 0 !== e && f && b !== e && d
        ? a.animate({ resolution: b, anchor: c, duration: d, easing: fd })
  ...
  function qg(a) {
    if (!(a instanceof Bd)) return !0;
    var b = !1,
      c = a.type;
    if ("pointerdown" === c || "pointerdrag" === c || "pointerup" === c)
      (c = a.b),
        "pointerup" == a.type
          ? delete this.Y[c.pointerId]
          : "pointerdown" == a.type
          ? (this.Y[c.pointerId] = c)
          : c.pointerId in this.Y && (this.Y[c.pointerId] = c),
        (this.l = rb(this.Y));
    this.A
      ? "pointerdrag" == a.type
        ? this.pf(a)
        : "pointerup" == a.type && (this.A = this.yf(a) && 0 < this.l.length)
      : "pointerdown" == a.type
      ? ((this.A = a = this.sf(a)), (b = this.Zc(a)))
      : "pointermove" == a.type && this.xf(a);
    return !b;
  }
  ...
  function vg(a) {
    var b = a.map;
    a = b.$();
    if (this.l.length) return this.a && $f(this.a), (this.g = null), !0;
    var c;
    if ((c = !this.j && this.a))
    ...
    c &&
      ...
      (f = a.Ba()),
      (f = b.Ka(f)),
      (b = b.Za([f[0] - c * Math.cos(e), f[1] - c * Math.sin(e)])),
      a.animate({ center: a.Ec(b), duration: 500, easing: fd }));
    Rf(a, 1, -1);
    return !1;
  }
  function tg(a) {
  ...
  function xg(a) {
    return ng(a) && hg(a) && this.g(a)
      ? (Rf(a.map.$(), 1, 1), (this.a = void 0), !0)
      : !1;
  }
  wg.prototype.Zc = bf;
  function Ag(a) {
  ...
  function Gg(a) {
    if (!ng(a)) return !0;
    this.a.setMap(null);
    this.o(a, this.g, a.pixel) &&
      (this.j(a), this.b(new Ig(Kg, a.coordinate, a)));
    return !1;
  }
  function Eg(a) {
  ...
  function Mg(a) {
    ...
    Dg.call(this, { condition: b, className: a.className || "ol-dragzoom" });
  }
  u(Mg, Dg);
  Mg.prototype.j = function () {
    ...
    e = jb(d);
    e = b.Ec(e);
    b.animate({ resolution: c, center: e, duration: this.C, easing: fd });
  };
  function Ng(a) {
      ...
      if (this.g(a) && (40 == c || 37 == c || 39 == c || 38 == c)) {
        ...
        if ((e = b.Ba()))
          (d = b.Ec([e[0] + d[0], e[1] + d[1]])),
            c ? b.animate({ duration: c, easing: hd, center: d }) : b.wb(d);
        a.preventDefault();
        b = !0;
      }
    }
  ...
  function Sg(a) {
    ...
    "wheel" == a.type
      ? ((d = c.deltaY),
        Gd && c.deltaMode === WheelEvent.DOM_DELTA_PIXEL && (d /= Kd),
        c.deltaMode === WheelEvent.DOM_DELTA_LINE && (d *= 40))
      : "mousewheel" == a.type && ((d = -c.wheelDeltaY), Hd && (d /= 3));
    if (0 === d) return !1;
    a = Date.now();
    void 0 === this.g && (this.g = a);
    if (!this.j || 400 < a - this.g) this.j = 4 > Math.abs(d) ? Tg : Ug;
    if (this.j === Tg) {
      b = b.$();
  ...
  function ch(a) {
    ...
    (void 0 !== a.pinchZoom ? a.pinchZoom : 1) &&
      b.push(new Zg({ duration: a.zoomDuration }));
    if (void 0 !== a.keyboard ? a.keyboard : 1)
      b.push(new Ng()),
        b.push(new Pg({ delta: a.zoomDelta, duration: a.zoomDuration }));
    (void 0 !== a.mouseWheelZoom ? a.mouseWheelZoom : 1) &&
      b.push(new Rg({ duration: a.zoomDuration }));
    (void 0 !== a.shiftDragZoom ? a.shiftDragZoom : 1) &&
      b.push(new Mg({ duration: a.zoomDuration }));
    return b;
  }
  function dh(a) {
    Gc.call(this);
  ...
  k.nl = function () {
    ...
    for (var b in this.c) this.c[b].forEach(rc);
    qb(this.c);
    var a = a.a,
      c,
      d;
  ...
  k.Lf = function (a) {
    ...
    for (d = b.length; c < d; c++)
      (e = b[c]),
        ...
        void 0 !== a.extent &&
          (e.extent = void 0 !== e.extent ? lb(e.extent, a.extent) : a.extent);
    return b;
  };
  k.Nf = function () {
    return "ready";
  ...
  k.setMap = function (a) {
    ...
    a &&
      ...
      (this.o = B(this, "change", a.render, a)),
      this.s());
  };
  k.Yc = function (a) {
    this.set("source", a);
  ...
  k = Hh.prototype;
  k.ra = function () {
    for (var a in this.c) Ac(this.c[a]);
  };
  function Jh() {
    if (32 < uh.a) {
      var a = 0,
  ...
  k.Aa = function (a, b, c, d, e, f, g) {
    ...
    for (q = n.length - 1; 0 <= q; --q) {
      ...
      if (
        ...
        f.call(g, r) &&
        ((v = Kh(this, r)),
        r.la() && (l = v.Aa(r.la().G ? m : a, b, c, h, e)),
        l)
      )
        return l;
    }
  ...
  function Yh(a, b, c, d, e) {
    var f, g;
    f = 0;
    for (g = d.length; f < g; ++f) c = Xh(a, b, c, d[f], e, !0);
    return c;
  }
  k = Sh.prototype;
  k.$b = function (a) {
  ...
  k.pe = function (a) {
    ...
    var b, c;
    b = 0;
    for (c = a.length; b < c; ++b) this.mc(a[b]);
  };
  k.qc = function (a) {
    var b = a.ha();
    a = a.sa();
  ...
  k.nc = function (a) {
    ...
    if (mb(this.c, b)) {
      if (this.b) {
        ...
        var g, h;
        g = 0;
        for (h = e.length; g < h; ++g) d = Xh(this, c, d, e[g], f, !1);
        b.stroke();
      }
  ...
  k.pc = function (a) {
    if (mb(this.c, a.D())) {
      if (this.b || this.a) {
        ...
        b.beginPath();
        g = 0;
        for (h = e.length; g < h; ++g) d = Yh(this, c, d, e[g], f);
        this.a && b.fill();
        this.b && b.stroke();
      }
  ...
  function Vh(a, b) {
    ...
    d
      ...
      : ((c.fillStyle = b.fillStyle), (a.R = { fillStyle: b.fillStyle }));
  }
  function Wh(a, b) {
    var c = a.f,
      d = a.S;
  ...
  k.Tb = function (a) {
    if (a) {
      var b = a.Ca();
      b
        ? ((b = b.b), (this.g = { fillStyle: Vc(b ? b : Nh) }))
        : (this.g = null);
      var c = a.Da();
      if (c) {
        var b = c.a,
  ...
  ci.prototype.vg = function (a) {
    if (a) {
      ...
      this.b.width != d || this.b.height != e
        ? ((this.b.width = d), (this.b.height = e))
        : b.clearRect(0, 0, d, e);
      ...
      for (g = f.length; e < g; ++e)
        (l = f[e]),
          (h = l.layer),
          (h = Kh(this, h)),
          sh(l, d) && "ready" == l.Ui && h.qd(a, l) && h.I(a, l, b);
      c && b.restore();
  ...
  ci.prototype.Yh = function (a, b, c, d, e, f) {
    ...
    for (--m; 0 <= m; --m) {
      g = l[m];
      var p = g.layer;
      if (sh(g, h) && e.call(f, p) && (g = Kh(this, p).v(a, b, c, d))) return g;
    }
  };
  ...
  k.Na = function (a, b) {
    ...
    e instanceof CanvasGradient || e instanceof CanvasPattern
      ? (e = ti)
      : (e =
          Qc(e).map(function (a, b) {
            return 3 != b ? a / 255 : a;
          }) || ti);
    (this.c.strokeColor &&
      ia(this.c.strokeColor, c) &&
      this.c.fillColor &&
      ia(this.c.fillColor, e) &&
      this.c.lineWidth === d) ||
      ((this.c.s = !0),
      (this.c.fillColor = e),
  ...
  function Ji(a, b) {
    ...
    (this.g = ea(ca, "OES_element_index_uint")) &&
  ...
  function ri(a, b, c) {
    ...
    if (f in a.a) d.bindBuffer(b, a.a[f].buffer);
      ...
      34962 == b
        ...
        : 34963 == b && (h = a.g ? new Uint32Array(e) : new Uint16Array(e));
    ...
    if (sb(c)) {
      ...
      for (g = f = 0, h = e.length; g < h; ++g) {
        ...
        for (
          ...
          f < this.f.length && this.f[f] <= m;

        ) {
          var n = w(this.g[f]).toString();
          void 0 !== c[n]
            ? (p !== l && si(a, b, p, l),
              (l = p = f === this.f.length - 1 ? m : this.f[f + 1]))
            : (l = f === this.f.length - 1 ? m : this.f[f + 1]);
          f++;
        }
        p !== l && si(a, b, p, l);
      }
  ...
  k.Vb = function (a) {
    ...
    var p;
    this.j.length
      ? ((p = this.j[this.j.length - 1]),
        w(p) != w(c) && (this.A.push(this.b.length), this.j.push(c)))
      : this.j.push(c);
    this.c.length
      ? ((p = this.c[this.c.length - 1]),
        w(p) != w(e) && (this.I.push(this.b.length), this.c.push(e)))
      : this.c.push(e);
    this.C = b[0];
    this.G = b[1];
    this.ta = m[1];
  ...
  function Zi(a, b, c, d) {
    ...
    for (e = 0; e < c; e += d) {
      ...
      if (e)
        ...
        z = [b[e + d], b[e + d + 1]];
        if (c - 0 === 2 * d && ia(y, z)) break;
        if (m) (x = [b[c - 2 * d], b[c - 2 * d + 1]]), (p = z);
        else {
          l &&
            ((f = $i(a, [0, 0], y, z, v * cj * l, f)),
            (f = $i(a, [0, 0], y, z, -v * cj * l, f)),
            (a.b[g++] = q + 2),
            (a.b[g++] = q),
            (a.b[g++] = q + 1),
    ...
    m &&
      ((q = q || f / 7),
      (n = Hf([x[0], x[1], y[0], y[1], z[0], z[1]], 0, 6, 2) ? 1 : -1),
      (f = $i(a, x, y, z, n * ej * (h || 1), f)),
      $i(a, x, y, z, -n * gj * (h || 1), f),
      (a.b[g++] = q),
      (a.b[g++] = r - 1),
      (a.b[g++] = r),
      (a.b[g++] = q + 1),
  ...
  k.Qb = function (a, b) {
    var c = a.ha(),
      d = a.sa();
    ij(c, c.length, d) &&
      ((c = ef(c, c.length, d, -this.origin[0], -this.origin[1])),
      this.c.s && (this.j.push(this.b.length), (this.c.s = !1)),
      this.f.push(this.b.length),
      this.g.push(b),
      Zi(this, c, c.length, d));
  };
  k.nc = function (a, b) {
    var c = this.b.length,
      d = a.hd(),
    ...
    for (f = d.length; e < f; ++e) {
      var g = d[e].ha(),
        h = d[e].sa();
      ij(g, g.length, h) &&
        ((g = ef(g, g.length, h, -this.origin[0], -this.origin[1])),
        Zi(this, g, g.length, h));
    }
    this.b.length > c &&
      (this.f.push(c),
      this.g.push(b),
      this.c.s && (this.j.push(c), (this.c.s = !1)));
  };
  function jj(a, b, c, d) {
    ...
    if (c.length) {
      ...
      for (e = c.length; b < e; ++b)
        Si(c[b], c[b].length, d) || (c[b].push(c[b][0]), c[b].push(c[b][1])),
          Zi(a, c[b], c[b].length, d);
    }
  }
  function kj(a, b, c) {
  ...
  k.qe = function (a, b, c, d, e) {
    ...
    for (f = this.j.length - 1; 0 <= f; --f)
      for (
        g = this.u[f], lj(this, a, g[0], g[1], g[2]), l = this.j[f];
        0 <= n && this.f[n] >= l;
  ...
  function tj(a) {
    ...
    if (b) {
      ...
      a.b = c || d;
      a.f === a.a
        ? ((a.b = void 0), (a.f = void 0), (a.a = void 0))
        : a.f === b
        ? (a.f = a.b)
        : a.a === b && (a.a = d ? a.b.ub : a.b);
      a.c--;
    }
  }
  function uj(a) {
  ...
  (function () {
    ...
    (function (c) {
      ...
      return (function d(a, b, g) {
        ...
        for (
          var f = "function" == typeof require && require, m = 0;
          m < g.length;
          m++
        )
          e(g[m]);
      ...
      })(
        {
                ...
                for (q = q || h; g > f; ) {
                  if (600 < g - f) {
                    ...
                    d(
                      a,
                      b,
                      Math.max(f, Math.floor(b - (m * n) / l + p)),
                      Math.min(g, Math.floor(b + ((l - m) * n) / l + p)),
                      q
                    );
                  }
                  l = a[b];
          ...
          2: [
            function (a, b) {
              ...
              function r(a, b) {
                return (
                  a.da <= b.da && a.fa <= b.fa && b.ba <= a.ba && b.ja <= a.ja
                );
              }
              function v(a, b) {
                return (
                  b.da <= a.ba && b.fa <= a.ja && b.ba >= a.da && b.ja >= a.fa
                );
              }
              function x(a) {
                return {
              ...
              d.prototype = {
                  ...
                  this.data.children.length
                    ? this.data.height === a.height
                      ...
                      : (this.data.height < a.height &&
                        ...
                        this.Og(a, this.data.height - a.height - 1, !0))
                    : (this.data = a);
                  return this;
                },
                Ea: function (a) {
                ...
                Mg: function (a, b, d, f) {
                  ...
                  for (y(a, b, d, h, this.Af); b <= d; b += h)
                    for (
                      n = Math.min(b + h - 1, d), y(a, b, n, g, this.Bf), m = b;
                      m <= n;
                      m += g
                    )
                      (p = Math.min(m + g - 1, n)),
                        l.children.push(this.Mg(a, m, p, f - 1));
                  e(l, this.yb);
                  return l;
                },
                Ij: function (a, b, d, e) {
                  for (var f, g, h, l, m, p, q, r; ; ) {
                    ...
                    for (g = b.children.length; f < g; f++)
                      (h = b.children[f]),
                        (m = n(h)),
                        (p =
                          (Math.max(h.ba, a.ba) - Math.min(h.da, a.da)) *
                            (Math.max(h.ja, a.ja) - Math.min(h.fa, a.fa)) -
                          m),
                        p < r
                          ? ((r = p), (q = m < q ? m : q), (l = h))
                          : p === r && m < q && ((q = m), (l = h));
                ...
                Og: function (a, b, d) {
                  ...
                  f.children.push(a);
                  for (l(f, d); 0 <= b; )
                    if (e[b].children.length > this.wf) this.Qj(e, b), b--;
                    else break;
                  this.Fj(d, e, b);
                },
                Qj: function (a, b) {
                  ...
                  for (e = b; e <= d - b; e++)
                    (f = h(a, 0, e, this.yb)),
                      ...
                      (l =
                        Math.max(
                          0,
                          Math.min(f.ba, g.ba) - Math.max(f.da, g.da)
                        ) *
                        Math.max(
                          0,
                          Math.min(f.ja, g.ja) - Math.max(f.fa, g.fa)
                        )),
                      (f = n(f) + n(g)),
                      l < m
                        ? ((m = l), (q = e), (p = f < p ? f : p))
  ...
  k = Ej.prototype;
  k.Ea = function (a, b) {
    var c = { da: a[0], fa: a[1], ba: a[2], ja: a[3], value: b };
    this.b.Ea(c);
    this.a[w(b)] = c;
  };
  k.load = function (a, b) {
    for (var c = Array(b.length), d = 0, e = b.length; d < e; d++) {
      var f = a[d],
        g = b[d],
        f = { da: f[0], fa: f[1], ba: f[2], ja: f[3], value: g };
      c[d] = f;
      this.a[w(g)] = f;
    }
    this.b.load(c);
  ...
  function Hj(a, b) {
    return a.b
      .search({ da: b[0], fa: b[1], ba: b[2], ja: b[3] })
      .map(function (a) {
        return a.value;
      });
  }
  ...
  function Lj(a, b, c, d) {
    ...
    if (c.length) {
      ...
      for (g = 0; g < l.length; ++g) Nj(l[g].list, l[g].ba, e, b, f);
    }
    Oj(e, f, !1);
    Pj(a, e, f);
  }
  function Mj(a, b, c, d, e, f) {
    ...
    if (f === Hf(b, 0, b.length, c))
      for (
        p = m = Qj(a, b[0], b[1], l++), f = b[0], g = c, h = b.length;
        g < h;
        g += c
      )
        (n = Qj(a, b[g], b[g + 1], l++)),
  ...
  function Oj(a, b, c) {
    ...
    do {
      var h = c
        ? wi(f.W.x, f.W.y, e.W.x, e.W.y, e.aa.x, e.aa.y)
        : wi(e.aa.x, e.aa.y, e.W.x, e.W.y, f.W.x, f.W.y);
      void 0 === h
        ? (Sj(e, f, a, b), (g = !0), f === d && (d = wj(a)), (f = e), xj(a))
        : e.W.vb !== h && ((e.W.vb = h), (g = !0));
      e = f;
      f = vj(a);
    } while (e !== d);
    return g;
    ...
    for (l = m.length; h < l; ++h) {
      ...
      if (void 0 === n.aa.vb) {
        var q = Uj(b, d, n.aa, n.W, !0),
          r = Math.abs(b.x - q[0]);
        r < g && ((g = r), (p = { x: q[0], y: q[1], gb: -1 }), (f = n));
      }
    }
    if (Infinity !== g) {
      m = f.W;
      if (0 < g && ((f = Vj(b, p, f.W, e)), f.length))
        for (p = Infinity, h = 0, l = f.length; h < l; ++h)
          if (
            ...
            (p = n), (m = g);
      for (f = uj(c); f.W !== m; ) f = vj(c);
      d = { x: b.x, y: b.y, gb: b.gb, vb: void 0 };
      h = { x: f.W.x, y: f.W.y, gb: f.W.gb, vb: void 0 };
      wj(a).aa = d;
      Rj(b, f.W, a, e);
      Rj(h, d, a, e);
      f.W = h;
  ...
  function Pj(a, b, c) {
    for (var d = !1, e = Wj(b, c); 3 < b.c; )
      if (e) {
        if (!Xj(a, b, c, e, d) && !Oj(b, c, d) && !Yj(a, b, c, !0)) break;
        ...
        if ((e = Wj(b, c))) {
          var d = b,
            ...
            l = h,
            m = 0;
          do (g[m++] = l.aa.x), (g[m++] = l.aa.y), (l = vj(d));
          while (l !== h);
          d = !Hf(g, 0, f, 2);
          Oj(b, c, d);
        } else {
      ...
      if (!1 === q.vb) {
        ...
        (!d && Tj({ aa: n, W: r }, c).length) ||
          ...
          (!d &&
            ...
            !1 !== r.vb &&
            Hf(
              [h.aa.x, h.aa.y, n.x, n.y, q.x, q.y, r.x, r.y, p.W.x, p.W.y],
              0,
              10,
              2
            ) !== !e) ||
  ...
  function Yj(a, b, c, d) {
    ...
    do {
      ...
      if (l) {
        ...
        m = n === e;
        d
          ? (l[0] === f.aa.x && l[1] === f.aa.y
              ? (xj(b), (l = f.aa), (g.aa = l), c.remove(f), (m = m || f === e))
              : ((l = g.W), (f.W = l), c.remove(g), (m = m || g === e)),
            tj(b))
          : ((l = Qj(a, l[0], l[1], p)),
            (f.W = l),
            (g.aa = l),
  ...
  function Qj(a, b, c, d) {
    ...
    a.a[e++] = b;
    a.a[e++] = c;
    return { x: b, y: c, gb: d, vb: void 0 };
  }
  function Rj(a, b, c, d) {
    var e = { aa: a, W: b },
      f = { ub: void 0, next: void 0, data: e },
      g = c.b;
    if (g) {
      var h = g.next;
      f.ub = g;
      ...
      h && (h.ub = f);
      g === c.a && (c.a = f);
    } else (c.f = f), (c.a = f), c.i && ((f.next = f), (f.ub = f));
    c.b = f;
    c.c++;
    d &&
      d.Ea(
      ...
      for (g in m[d])
        (h = m[d][g]),
          "object" !== typeof h ||
            ...
            (h.x === c.x && h.y === c.y) ||
            -1 !== l.indexOf(h) ||
            !Bf([a.x, a.y, b.x, b.y, c.x, c.y], 0, 6, 2, h.x, h.y) ||
            l.push(h);
    return l;
  }
  function Tj(a, b, c) {
  ...
  k.pc = function (a, b) {
    ...
    for (h = c.length; g < h; ++g) {
      ...
      if (0 < p.length) {
        ...
        for (m = p.length; l < m; ++l)
          (r = p[l].ha()),
            (r = ef(r, r.length, d, -this.origin[0], -this.origin[1])),
            q.push(r);
        jj(this.l, n, q, d);
        Lj(this, n, q, d);
      }
    ...
    this.b.length > e &&
      (this.f.push(e),
      this.g.push(b),
      this.j.s && (this.c.push(e), (this.j.s = !1)));
  ...
  k.rc = function (a, b) {
    ...
    if (0 < c.length) {
      ...
      for (h = c.length; g < h; ++g)
        (l = c[g].ha()),
          (l = ef(l, l.length, d, -this.origin[0], -this.origin[1])),
          f.push(l);
      jj(this.l, e, f, d);
      Lj(this, e, f, d);
    }
  ...
  k.qe = function (a, b, c, d, e) {
    ...
    for (f = this.c.length - 1; 0 <= f; --f)
      for (
        g = this.u[f], a.uniform4fv(this.I.G, g), l = this.c[f];
        0 <= n && this.f[n] >= l;
  ...
  k.Na = function (a, b) {
    ...
    (this.j.fillColor && ia(c, this.j.fillColor)) ||
      ((this.j.fillColor = c), (this.j.s = !0), this.u.push(c));
    b
      ? this.l.Na(null, b)
      : this.l.Na(null, new rj({ color: [0, 0, 0, 0], lineWidth: 0 }));
  };
  function ak() {}
  ...
  function fk(a, b, c, d, e, f, g, h, l, m, p) {
    ...
    for (v = q.length; r < v; ++r)
      for (y = a.a[q[r].toString()], x = ei.length - 1; 0 <= x; --x)
        if (
          ((z = y[ei[x]]),
          void 0 !== z && (z = z.i(b, c, d, e, n, f, g, h, l, m, p)))
        )
          return z;
  }
  ...
  var gk = [1, 1],
    ek = { Circle: Ai, Image: Pi, LineString: Yi, Polygon: Kj, Text: ak };
  ...
  k.forEach = function (a, b) {
    for (var c = this.a; c; ) a.call(b, c.$c, c.tc, this), (c = c.Lb);
  };
  k.get = function (a) {
    a = this.b[a];
    qa(!!a, 15);
    if (a === this.f) return a.$c;
    a === this.a
      ? ((this.a = this.a.Lb), (this.a.td = null))
      : ((a.Lb.td = a.td), (a.td.Lb = a.Lb));
    a.Lb = null;
    a.td = this.f;
    this.f = this.f.Lb = a;
    return a.$c;
  ...
  k.set = function (a, b) {
    qa(!(a in this.b), 16);
    var c = { tc: a, Lb: null, td: this.f, $c: b };
  ...
  function lk(a, b, c, d) {
    ...
    if (a.a.b.hasOwnProperty(f))
      (a = a.a.get(f)),
        e.bindTexture(3553, a.Fb),
        9729 != a.Bh && (e.texParameteri(3553, 10240, 9729), (a.Bh = 9729)),
        9729 != a.Dh && (e.texParameteri(3553, 10241, 9729), (a.Dh = 9729));
    else {
      ...
      } else e.texImage2D(3553, 0, 6408, 6408, 5121, b.Z());
      ...
      a.a.set(f, { Fb: g, Bh: 9729, Dh: 9729 });
    }
  }
  function nk(a, b, c) {
    var d = a.j;
  ...
  k.bk = function (a, b) {
    for (var c = this.f, d; 1024 < this.a.c - this.g; ) {
      if ((d = this.a.a.$c)) c.deleteTexture(d.Fb);
      else if (+this.a.a.tc == b.index) break;
      else --this.g;
      this.a.pop();
    }
  };
  ...
  k.vg = function (a) {
    ...
    for (h = e.length; g < h; ++g)
      (m = e[g]),
        sh(m, f) &&
          "ready" == m.Ui &&
          ((l = Kh(this, m.layer)), l.ag(a, m, b) && d.push(m));
  ...
  function G(a) {
    ...
    a =
      "click dblclick mousedown touchstart mspointerdown pointerdown mousewheel wheel".split(
        " "
      );
    for (var c = 0, d = a.length; c < d; ++c) B(this.u, a[c], Cc);
    this.c.appendChild(this.u);
    this.Ja = new xe(this);
    for (var e in Ad) B(this.Ja, Ad[e], this.uh, this);
  ...
  k.ra = function () {
    ...
    this.i &&
      (window.removeEventListener("resize", this.i, !1), (this.i = void 0));
    ...
    if (this.a)
      return (
        ...
        this.C.Aa(
          ...
          b,
          null,
          c.layerFilter ? c.layerFilter : af,
          null
        )
      );
  };
  ...
  k.El = function (a, b) {
    ...
    return this.C.Zh(
      ...
      b.layerFilter ? b.layerFilter : af,
      null
    );
  };
  k.sk = function (a) {
  ...
  k.Wk = function (a, b, c, d) {
    var e = this.a;
    if (!(e && b in e.wantedTiles && e.wantedTiles[b][a.ib()])) return Infinity;
    a = c[0] - e.focus[0];
    c = c[1] - e.focus[1];
  ...
  k.Dl = function () {
    ...
    var a = this.$();
    a &&
      (this.c.setAttribute("data-view", w(a)),
      (this.S = B(a, "propertychange", this.xh, this)),
      (this.R = B(a, "change", this.xh, this)));
    this.render();
  };
  k.kl = function () {
  ...
  k.hp = function (a) {
    ...
    this.C.vg(g);
    g &&
      (g.animate && this.render(),
      Array.prototype.push.apply(this.Oa, g.postRenderFunctions),
      g.viewHints[0] ||
        g.viewHints[1] ||
        Za(g.extent, this.lb) ||
        (this.b(new yd("moveend", this, g)), Na(g.extent, this.lb)));
  ...
  function pk(a) {
    ...
    if (void 0 === a.logo || ("boolean" === typeof a.logo && a.logo))
      ...
      "string" === typeof e
        ...
        ? (d[w(e).toString()] = e)
        : e &&
          (qa("string" == typeof e.href, 44),
          qa("string" == typeof e.src, 45),
          (d[e.src] = e.href));
    }
    ...
    void 0 !== a.controls
      ? Array.isArray(a.controls)
        ? (f = new D(a.controls.slice()))
        : (qa(a.controls instanceof D, 47), (f = a.controls))
      : (f = nd());
    void 0 !== a.interactions
      ? Array.isArray(a.interactions)
        ? (g = new D(a.interactions.slice()))
        : (qa(a.interactions instanceof D, 48), (g = a.interactions))
      : (g = ch());
    void 0 !== a.overlays
      ? Array.isArray(a.overlays)
        ? (a = new D(a.overlays.slice()))
        : (qa(a.overlays instanceof D, 49), (a = a.overlays))
      : (a = new D());
    return {
      controls: f,
      interactions: g,
  ...
  k.pl = function () {
    ...
    var a = this.Ge();
    a &&
      ((this.i = B(a, "postrender", this.render, this)),
      wk(this),
      (a = this.v ? a.u : a.A),
      this.o
        ? a.insertBefore(this.c, a.childNodes[0] || null)
        : a.appendChild(this.c));
  };
  k.render = function () {
    wk(this);
  ...
  function yk(a, b) {
    a.a.visible !== b &&
      ((a.c.style.display = b ? "" : "none"), (a.a.visible = b));
  }
  function wk(a) {
    var b = a.Ge(),
      c = a.Kh();
    if (b && b.a && c) {
      ...
      if ("bottom-right" == f || "center-right" == f || "top-right" == f)
        "" !== a.a.Ce && (a.a.Ce = b.left = ""),
          (g = Math.round(d[0] - c[0] - g) + "px"),
          a.a.bf != g && (a.a.bf = b.right = g);
      else {
  ...
  k.setMap = function (a) {
    ...
    a !== b &&
      (b &&
        ((b = b.$()) && xc(b, Ic("rotation"), this.Ae, this), this.c.Fe(null)),
      ad.prototype.setMap.call(this, a),
      a &&
        (this.c.Fe(this.C),
        this.v.push(B(a, "propertychange", this.ql, this)),
        this.c.Jh().ec() || this.c.Li(a.Jc()),
        (a = a.$()))) &&
      (B(a, Ic("rotation"), this.Ae, this), Yf(a) && (this.c.xd(), Bk(this)));
  };
  k.ql = function (a) {
    "view" === a.key &&
      ((a = a.oldValue) && xc(a, Ic("rotation"), this.Ae, this),
      (a = this.a.$()),
      B(a, Ic("rotation"), this.Ae, this));
  };
  k.Ae = function () {
    this.c.$().He(this.a.$().Va());
  };
  function Ak() {
    ...
    if (a.a && b.a) {
      ...
      b < 0.1 * f || e < 0.1 * d || b > 0.75 * f || e > 0.75 * d
        ? Bk(this)
        : Ta(c, a) || ((a = this.c), (c = this.a.$()), a.$().wb(c.Ba()));
    }
    Ck(this);
  }
  function Bk(a) {
  ...
  function Ik(a) {
    ...
    } else a.l && ((a.c.style.display = "none"), (a.l = !1));
  }
  var Gk = "units";
  function Jk(a) {
    a = a ? a : {};
    ...
    B(c, "click", Cc);
    ad.call(this, { element: d, render: a.render ? a.render : Lk });
  }
  u(Jk, ad);
  ...
  k.bl = function (a) {
    ...
    a = Nk(
      ...
      wa(
        1 === this.l
          ? (a.offsetX - this.R[0] / 2) / this.A
          : (a.offsetY - this.R[1] / 2) / this.o,
        0,
        1
      )
    );
  ...
  k.cl = function (a) {
    if (this.u) {
      ...
      this.c = Nk(
        ...
        wa(
          1 === this.l
            ? (a.clientX - this.C + parseInt(b.style.left, 10)) / this.A
            : (a.clientY - this.G + parseInt(b.style.top, 10)) / this.o,
          0,
          1
        )
      );
    ...
    if (null !== a.alpha) {
      ...
      "boolean" === typeof a.absolute && a.absolute
        ...
        : "number" === typeof a.webkitCompassHeading &&
          ...
          this.set(Sk, Ba(a.webkitCompassHeading));
    }
  ...
  k.cm = function () {
    if (Nd) {
      var a = this.Fh();
      a && !this.a
        ? (this.a = B(window, "deviceorientation", this.qo, this))
        : a || null === this.a || (rc(this.a), (this.a = null));
    }
  };
  k.Uf = function (a) {
    this.set(Qk, a);
  ...
  function Xk(a, b) {
    ...
    void 0 === b
      ? ((e = Xc(m, m)),
        ...
        a.Wa
          ? (a.A = a.I)
          : ((e = Xc(d.size, d.size)), (a.A = e.canvas), a.$g(d, e, 0, 0)))
      : ((m = Math.round(m)),
        (e = !a.Wa) && (c = a.$g.bind(a, d)),
        a.Ya
          ? ((f = a.Ya),
            void 0 === f.b &&
              ((f.b = "s"),
        ...
        (a.i &&
          ...
          (a.i = [
            "r" +
              ...
              (void 0 !== a.f ? a.f.toString() : "-") +
              (void 0 !== a.j ? a.j.toString() : "-") +
        ...
        (d = b.add(a.i[0], m, m, a.ah.bind(a, d), c)),
        (a.I = d.image),
        (a.qa = [d.offsetX, d.offsetY]),
        (c = d.image.width),
        (a.A = e ? d.Fl : a.I));
    a.C = [m / 2, m / 2];
    a.ta = [m, m];
  ...
  k.ah = function (a, b, c, d) {
    ...
    if (Infinity === this.b)
      ...
      for (this.f !== this.a && (this.b *= 2), c = 0; c <= this.b; c++)
        (d = (2 * c * Math.PI) / this.b - Math.PI / 2 + this.j),
          (e = c % 2 ? this.f : this.a),
  ...
  k.$g = function (a, b, c, d) {
    ...
    if (Infinity === this.b)
      ...
      var e;
      for (c = 0; c <= this.b; c++)
        (e = (2 * c * Math.PI) / this.b - Math.PI / 2 + this.j),
          (d = c % 2 ? this.f : this.a),
  ...
  function dl() {
    if (!cl) {
      var a = new Zk({ color: "rgba(255,255,255,0.4)" }),
        b = new rj({ color: "#3399CC", width: 1.25 });
      cl = [
        new $k({
  ...
  function el() {
    var a = {},
      b = [255, 255, 255, 1],
      c = [0, 153, 255, 1];
    a.Polygon = [new $k({ fill: new Zk({ color: [255, 255, 255, 0.5] }) })];
    a.MultiPolygon = a.Polygon;
    a.LineString = [
      new $k({ stroke: new rj({ color: b, width: 5 }) }),
      new $k({ stroke: new rj({ color: c, width: 3 }) }),
    ];
    ...
    a.Point = [
      new $k({
        image: new Yk({
          radius: 6,
          fill: new Zk({ color: c }),
          stroke: new rj({ color: b, width: 1.5 }),
        }),
        zIndex: Infinity,
      }),
    ];
  ...
  function kl(a, b, c) {
    if (a.nodeType == Node.CDATA_SECTION_NODE || a.nodeType == Node.TEXT_NODE)
      b
        ...
        : c.push(a.nodeValue);
    else for (a = a.firstChild; a; a = a.nextSibling) kl(a, b, c);
    return c;
  }
  function ll(a) {
      ...
      h.onload = function () {
        if (!h.status || (200 <= h.status && 300 > h.status)) {
          ...
          "json" == a || "text" == a
            ? (e = h.responseText)
            : "xml" == a
            ? (e = h.responseXML) || (e = nl(h.responseText))
            : "arraybuffer" == a && (e = h.response);
          e
            ? c.call(this, b.Qa(e, { featureProjection: g }), b.kb(e))
            : d.call(this);
        } else d.call(this);
      }.bind(this);
      h.send();
  ...
  function El(a, b) {
    return pb(
      { dataProjection: a.defaultDataProjection, featureProjection: a.g },
      b
    );
  }
  function Fl(a, b, c) {
    ...
    d && e && !Tb(d, e)
      ? a instanceof cf
        ? (f = (b ? a.clone() : a).tb(b ? d : e, b ? e : d))
        : (f = Xb(b ? a.slice() : a, b ? d : e, b ? e : d))
      : (f = a);
    if (b && c && c.decimals) {
  ...
  function Jl(a, b, c, d, e, f) {
    ...
    c = [];
    var g;
    for (g = 0; g < d - 1; ++g) c.push(Da(a[(b - 1) * d + g], a[b * d + g], f));
    c.push(e);
    return c;
  }
  function Kl(a, b, c, d, e, f) {
    var g = 0;
    if (f) return Jl(a, g, b[b.length - 1], c, d, e);
    if (d < a[c - 1])
    ...
    for (f = b.length; e < f; ++e) {
      ...
      if (g != h) {
        if (d < a[g + c - 1]) break;
        else if (d <= a[h - 1]) return Jl(a, g, h, c, d, !1);
        g = h;
      }
    }
    return null;
  ...
  k.Gb = function (a, b, c, d) {
    if (d < Oa(this.D(), a, b)) return d;
    this.u != this.f &&
      ((this.A = Math.sqrt(nf(this.B, 0, this.B.length, this.a, 0))),
      (this.u = this.f));
  ...
  k.Im = function (a, b) {
    return "XYM" != this.ka && "XYZM" != this.ka
      ? null
      : Jl(this.B, 0, this.B.length, this.a, a, void 0 !== b ? b : !1);
  };
  k.X = function () {
    return uf(this.B, 0, this.B.length, this.a);
  };
  ...
  k.Gb = function (a, b, c, d) {
    if (d < Oa(this.D(), a, b)) return d;
    this.l != this.f &&
      ((this.u = Math.sqrt(of(this.B, 0, this.c, this.a, 0))),
      (this.l = this.f));
    return qf(this.B, 0, this.c, this.a, this.u, !1, a, b, c, d);
  };
  k.Lm = function (a, b, c) {
    return ("XYM" != this.ka && "XYZM" != this.ka) || !this.B.length
      ? null
      : Kl(
          this.B,
          this.c,
  ...
  k.Xa = function (a) {
    ...
    for (e = b.length; d < e; d += c)
      if (((f = b[d]), (g = b[d + 1]), Sa(a, f, g))) return !0;
    return !1;
  };
  k.pa = function (a, b) {
    a
  ...
  k.Xj = function (a) {
    ...
    } else (this.B = a.ha().slice()), (a = a.Rb().slice()), this.c.push();
    this.c.push(a);
    this.s();
  };
  k.clone = function () {
    for (
      var a = new P(null), b = this.c.length, c = Array(b), d = 0;
      d < b;
      ++d
    )
      c[d] = this.c[d].slice();
  ...
  k.X = function (a) {
    var b;
    void 0 !== a
      ? ((b = ai(this).slice()), Kf(b, this.c, this.a, a))
      : (b = this.B);
    a = b;
    b = this.c;
    var c = this.a,
  ...
  function Pl(a, b) {
    ...
    if ("number" === typeof a.x && "number" === typeof a.y) c = "Point";
      ...
      for (l = d.length; h < l; ++h)
        (f.length = 0),
          sf(f, 0, d[h], e.length),
          Hf(f, 0, f.length, e.length) ? g.push([d[h]]) : c.push(d[h]);
      for (; c.length; ) {
        d = c.shift();
        e = !1;
        for (h = g.length - 1; 0 <= h; h--)
      ...
      a = pb({}, a);
      1 === g.length
        ? ((c = "Polygon"), (a.rings = g[0]))
        : ((c = "MultiPolygon"), (a.rings = g));
    }
  ...
  var Rl = {
      Point: function (a) {
        return void 0 !== a.m && void 0 !== a.z
          ? new E([a.x, a.y, a.z, a.m], "XYZM")
          : void 0 !== a.z
          ? new E([a.x, a.y, a.z], "XYZ")
          : void 0 !== a.m
          ? new E([a.x, a.y, a.m], "XYM")
          : new E([a.x, a.y]);
      },
  ...
  k.kg = function (a, b) {
    ...
    if (a.features) {
      ...
      f = 0;
      for (g = e.length; f < g; ++f) d.push(this.Sc(e[f], c));
      return d;
    }
    return [this.Sc(a, c)];
  };
  ...
  k.rg = function (a) {
    return a.spatialReference && a.spatialReference.wkid
      ? Gb("EPSG:" + a.spatialReference.wkid)
      : null;
  };
  function Ul(a, b) {
  ...
  k.ad = function (a, b) {
    ...
    b &&
      b.featureProjection &&
      (c.spatialReference = {
        wkid: Gb(b.featureProjection).nb.split(":").pop(),
      });
    return c;
  };
  k.ce = function (a, b) {
    ...
    var c = [],
      ...
      e;
    d = 0;
    for (e = a.length; d < e; ++d) c.push(this.ad(a[d], b));
    return { features: c };
  };
  function Vl(a) {
    this.Bc = a;
  ...
  function tm(a) {
    var b, c;
    if (a.a)
      for (b = 0, c = a.a.length; b < c; ++b) xc(a.a[b], "change", a.s, a);
  }
  function rm(a) {
    var b, c;
    if (a.a)
      for (b = 0, c = a.a.length; b < c; ++b) B(a.a[b], "change", a.s, a);
  }
  k = qm.prototype;
  k.clone = function () {
    var a = new qm(null);
  ...
  k.Gb = function (a, b, c, d) {
    ...
    var e = this.a,
      ...
      g;
    f = 0;
    for (g = e.length; f < g; ++f) d = e[f].Gb(a, b, c, d);
    return d;
  };
  k.Oc = function (a, b) {
    var c = this.a,
      ...
      e;
    d = 0;
    for (e = c.length; d < e; ++d) if (c[d].Oc(a, b)) return !0;
    return !1;
  };
  k.ne = function (a) {
    Va(Infinity, Infinity, -Infinity, -Infinity, a);
    for (var b = this.a, c = 0, d = b.length; c < d; ++c) $a(a, b[c].D());
    return a;
  };
  k.If = function () {
    return sm(this.a);
  ...
  k.Qd = function (a) {
    ...
    if (e)
      return (
        (a = new qm(null)), tm(a), (a.a = c), rm(a), a.s(), (this.i[b] = a)
      );
    this.g = a;
    return this;
  };
  ...
  k.Xa = function (a) {
    var b = this.a,
      ...
      d;
    c = 0;
    for (d = b.length; c < d; ++c) if (b[c].Xa(a)) return !0;
    return !1;
  };
  k.rotate = function (a, b) {
  ...
  var wm = {
    ...
    ym = {
      ...
      LineString: function (a) {
        return { type: "LineString", coordinates: a.X() };
      },
  ...
  k.kg = function (a, b) {
    ...
    if ("FeatureCollection" === a.type) {
      ...
      var d = a.features,
        ...
        f;
      e = 0;
      for (f = d.length; e < f; ++e) c.push(this.Sc(d[e], b));
    } else c = [this.Sc(a, b)];
    return c;
  };
  k.og = function (a, b) {
  ...
  k.rg = function (a) {
    ...
    a
      ? "name" == a.type
        ? (b = Gb(a.properties.name))
        : "EPSG" == a.type
        ? (b = Gb("EPSG:" + a.properties.code))
        : qa(!1, 36)
  ...
  k.Ub = function (a, b) {
    if (ll(a)) return Am(this, a, b);
    if (ml(a)) return this.jg(a, b);
    if ("string" === typeof a) {
      var c = nl(a);
      return Am(this, c, b);
    }
  ...
  k.Qa = function (a, b) {
    if (ll(a)) return Bm(this, a, b);
    if (ml(a)) return this.yc(a, b);
    if ("string" === typeof a) {
      var c = nl(a);
      return Bm(this, c, b);
    }
    ...
    if ("FeatureCollection" == c)
      ...
      for (v in g) {
        ...
        for (l = f.length; h < l; ++h)
          (-1 === f[h].indexOf(":") ? "p0" : f[h].split(":")[0]) === v &&
            (p[f[h].split(":").pop()] =
              "featureMembers" == c ? ql(this.ig, this) : rl(this.ig, this));
        e[g[v]] = p;
      }
  ...
  k.ig = function (a, b) {
    ...
    for (c = a.firstElementChild; c; c = c.nextElementSibling) {
      ...
      if (
        ...
        Dm.test(h) && (h = void 0);
        e[g] = h;
      } else "boundedBy" !== g && (f = g), (e[g] = this.We(c, b));
    }
    c = new H(e);
    f && c.Vc(f);
    d && c.kc(d);
  ...
  k.Ye = function (a, b) {
    ...
    if (c && c[0]) {
      var d = new F(null),
        ...
        h;
      g = 1;
      for (h = c.length; g < h; ++g) ga(e, c[g]), f.push(e.length);
      d.ca("XYZ", e, f);
      return d;
    }
  };
  ...
  k.ng = function (a, b) {
    ...
    a.getAttribute("srsDimension")
      ? (d = Km(a.getAttribute("srsDimension")))
      : a.getAttribute("dimension")
      ? (d = Km(a.getAttribute("dimension")))
      : e && (d = Km(e));
  ...
  k.vj = {
    "http://www.opengis.net/gml": { PolygonPatch: rl(Pm.prototype.Uo) },
  };
  k.Aj = {
    "http://www.opengis.net/gml": { LineStringSegment: rl(Pm.prototype.Oo) },
  };
  function Qm(a, b, c) {
  ...
  var Rm = {
    "http://www.opengis.net/gml": { lowerCorner: J(Mm), upperCorner: J(Mm) },
  };
  k = Pm.prototype;
  k.Jp = function (a, b, c) {
    var d = c[c.length - 1].srsName;
  ...
  k.nf = function (a, b, c) {
    ...
    "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName
      ? ((b = b.jd()),
        zl({ node: a, srsName: d }, Sm, this.zj, b, c, void 0, this))
      : "Surface" === a.nodeName &&
        ((d = il(a.namespaceURI, "patches")),
        a.appendChild(d),
        (a = il(d.namespaceURI, "PolygonPatch")),
        d.appendChild(a),
        this.nf(a, b, c));
  };
  k.mf = function (a, b, c) {
    ...
    "LineString" === a.nodeName || "LineStringSegment" === a.nodeName
      ? ((d = il(a.namespaceURI, "posList")), a.appendChild(d), Qm(d, b, c))
      : "Curve" === a.nodeName &&
        ((d = il(a.namespaceURI, "segments")),
        a.appendChild(d),
        (a = il(d.namespaceURI, "LineStringSegment")),
        d.appendChild(a),
        this.mf(a, b, c));
  };
  k.gj = function (a, b, c) {
    ...
    b = b.Od();
    zl({ node: a, srsName: e, surface: d }, Tm, this.c, b, c, void 0, this);
  };
  k.Kp = function (a, b, c) {
    var d = c[c.length - 1].srsName;
    d && a.setAttribute("srsName", d);
    b = b.Ie();
    zl({ node: a, srsName: d }, Um, ul("pointMember"), b, c, void 0, this);
  };
  k.fj = function (a, b, c) {
    var d = c[c.length - 1],
      e = d.srsName,
    ...
    e && a.setAttribute("srsName", e);
    b = b.hd();
    zl({ node: a, srsName: e, curve: d }, Vm, this.c, b, c, void 0, this);
  };
  k.ij = function (a, b, c) {
  ...
  k.zd = function (a, b, c) {
    ...
    Array.isArray(b)
      ? d.dataProjection
        ? (f = Xb(b, d.featureProjection, d.dataProjection))
        : (f = b)
      : (f = Fl(b, !0, d));
  ...
  k.cj = function (a, b, c) {
    ...
    for (l in g) {
      ...
      null !== m &&
        ...
        h.push(m),
        l == f || m instanceof cf
          ? l in d.Uc[e] || (d.Uc[e][l] = J(this.zd, this))
          : l in d.Uc[e] || (d.Uc[e][l] = J(Mm)));
    }
    l = pb({}, d);
    l.node = a;
  ...
  function fn(a, b) {
    var c = b[0],
      d = L({ flatCoordinates: [], layoutOptions: {} }, gn, a, b);
    if (d) {
  ...
  function hn(a, b) {
    var c = b[0],
      d = L({ flatCoordinates: [], ends: [], layoutOptions: {} }, jn, a, b);
    if (d) {
      var e = d.flatCoordinates;
      delete d.flatCoordinates;
      var f = d.ends;
  ...
  var mn = { rte: fn, trk: hn, wpt: kn },
    nn = K($m, { rte: ql(fn), trk: ql(hn), wpt: ql(kn) }),
    dn = K($m, { text: I(Q, "linkText"), type: I(Q, "linkType") }),
    gn = K($m, {
      name: I(Q),
      cmt: I(Q),
      desc: I(Q),
  ...
  Zm.prototype.jg = function (a, b) {
    if (!ea($m, a.namespaceURI)) return null;
  ...
  Zm.prototype.yc = function (a, b) {
    if (!ea($m, a.namespaceURI)) return [];
    if ("gpx" == a.localName) {
      var c = L([], nn, a, [Dl(this, a, b)]);
      if (c) return rn(this, c), c;
    }
    return [];
  };
  function sn(a, b, c) {
  ...
  function vn(a, b, c) {
    ...
    d = xl(f, b);
    zl({ node: a, properties: f }, yn, wl, d, c, b);
  }
  var un = ["text", "type"],
    tn = K($m, { text: J(Mm), type: J(Mm) }),
    ...
    Fn = { Point: "wpt", LineString: "rte", MultiLineString: "trk" };
  function Gn(a, b) {
    var c = a.U();
    if (c && (c = Fn[c.T()])) return il(b[b.length - 1].node.namespaceURI, c);
  }
  var Hn = K($m, {
    ...
    trk: J(function (a, b, c) {
      var d = c[0],
        e = b.N();
      a = { node: a, properties: e };
      if ((b = b.U())) (b = Fl(b, !0, d)), (e.trkseg = b.hd());
  ...
  Pn.prototype.I = function () {
    ...
    if (!this.o && null !== this.g) {
      ...
      for (
        var b = a.getImageData(0, 0, this.M.width, this.M.height),
          c = b.data,
          d = this.g[0] / 255,
          e = this.g[1] / 255,
          f = this.g[2] / 255,
  ...
  function Rn(a) {
    a = a || {};
    this.j = void 0 !== a.anchor ? a.anchor : [0.5, 0.5];
    this.I = null;
  ...
  function Tn(a) {
    ...
    Un ||
      ...
      (Yn = Zn = "pixels"),
      ($n = [64, 64]),
      (ao = "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png"),
      (bo = 0.5),
      (co = new Rn({
        anchor: Xn,
      ...
      (eo = "NO_IMAGE"),
      (fo = new rj({ color: Vn, width: 1 })),
      (go = new rj({ color: [51, 51, 51, 1], width: 2 })),
      (ho = new Sn({
      ...
      (io = new $k({ fill: Wn, image: co, text: ho, stroke: fo, zIndex: 0 })),
      (Un = [io]));
    this.defaultDataProjection = Gb("EPSG:4326");
  ...
  var jo = ["http://www.google.com/kml/ext/2.2"],
    ...
    lo = { fraction: "fraction", pixels: "pixels" };
  function mo(a, b) {
    var c,
      d = [0, 0],
      e = "start";
  ...
  function no(a, b, c, d, e) {
    return function () {
      ...
      if (a) return f ? ((f = mo(a[0], g)), a.concat(f)) : a;
      if (b) {
        var h = oo(b, c, d);
  ...
  function Bo(a, b) {
    ...
    if (e)
      if ("Point" == f) {
        ...
        f = d.ha();
        h = 1;
        for (l = c.length; h < l; ++h) (g = c[h]), ga(f, g.ha());
        d = new O(null);
        d.ca(e, f);
        Do(d, c);
      } else
        "LineString" == f
          ? ((d = new N(null)), Ll(d, c), Do(d, c))
          : "Polygon" == f
          ? ((d = new P(null)), Nl(d, c), Do(d, c))
  ...
  function Fo(a, b) {
    ...
    if (d && d[0]) {
      var e = new F(null),
        ...
        l;
      h = 1;
      for (l = d.length; h < l; ++h) ga(f, d[h]), g.push(f.length);
      e.ca("XYZ", f, g);
      e.H(c);
      return e;
    }
  ...
  function Ho(a, b) {
    ...
    var f = "textStyle" in c ? c.textStyle : ho,
      ...
      c = c.outline;
    void 0 === c || c || (g = null);
    return [new $k({ fill: d, image: e, stroke: g, text: f, zIndex: void 0 })];
  }
  function Do(a, b) {
    var c = b.length,
      d = Array(b.length),
  ...
  var No = K(ko, { displayName: I(Q), value: I(Q) }),
    Ko = K(ko, {
      Data: function (a, b) {
    ...
    yo = K(ko, { extrude: I(Em), altitudeMode: I(Q) }),
    ...
    To = K(
      ko,
      { href: I(ro) },
      K(jo, { x: I(Hm), y: I(Hm), w: I(Hm), h: I(Hm) })
    ),
    Uo = K(ko, {
      Icon: I(function (a, b) {
        var c = L({}, To, a, b);
    ...
    Vo = K(ko, { color: I(po), scale: I(so) }),
    Wo = K(ko, { color: I(po), width: I(Hm) }),
    Co = K(ko, {
      LineString: ql(xo),
      LinearRing: ql(Ao),
      MultiGeometry: ql(Bo),
    ...
    $o = K(ko, { Style: I(Ho), key: I(Q), styleUrl: I(ro) }),
    bp = K(
      ko,
      {
        ExtendedData: Jo,
    ...
    cp = K(ko, { color: I(po), fill: I(Em), outline: I(Em) }),
    Oo = K(ko, {
    ...
    Io = K(ko, {
      IconStyle: function (a, b) {
        ...
        if (c) {
          ...
          var l, m, p;
          (h = c.hotSpot)
            ? ((l = [h.x, h.y]), (m = h.Hg), (p = h.Ig))
            : g === ao
            ? ((l = Xn), (m = Zn), (p = Yn))
            : /^http:\/\/maps\.(?:google|gstatic)\.com\//.test(g) &&
              ((l = [0.5, 0]), (p = m = "fraction"));
          var n,
            h = e.x,
            q = e.y;
      ...
      LineStyle: function (a, b) {
        var c = L({}, Wo, a, b);
        c &&
          (b[b.length - 1].strokeStyle = new rj({
  ...
  k.jg = function (a, b) {
    if (!ea(ko, a.namespaceURI)) return null;
    var c = this.pg(a, [Dl(this, a, b)]);
    return c ? c : null;
  };
  k.yc = function (a, b) {
    if (!ea(ko, a.namespaceURI)) return [];
    var c;
    c = a.localName;
    if ("Document" == c || "Folder" == c)
      return (c = this.hg(a, [Dl(this, a, b)])) ? c : [];
    if ("Placemark" == c) return (c = this.pg(a, [Dl(this, a, b)])) ? [c] : [];
    if ("kml" == c) {
      c = [];
      var d;
  ...
  k.Ro = function (a) {
    if (ll(a)) return dp(this, a);
    if (ml(a)) return ep(this, a);
    if ("string" === typeof a) return (a = nl(a)), dp(this, a);
  };
  function dp(a, b) {
    var c;
  ...
  function ep(a, b) {
    ...
    for (c = b.firstElementChild; c; c = c.nextElementSibling)
      if (ea(ko, c.namespaceURI) && "name" == c.localName) return Q(c);
    for (c = b.firstElementChild; c; c = c.nextElementSibling) {
      var d = c.localName;
      if (
        ea(ko, c.namespaceURI) &&
  ...
  k.So = function (a) {
    ...
    ll(a)
      ...
      : ml(a)
      ? ga(b, gp(this, a))
      : "string" === typeof a && ((a = nl(a)), ga(b, fp(this, a)));
    return b;
  };
  function fp(a, b) {
    var c,
  ...
  k.Vo = function (a) {
    ...
    ll(a)
      ...
      : ml(a)
      ? ga(b, this.$e(a))
      : "string" === typeof a && ((a = nl(a)), ga(b, hp(this, a)));
    return b;
  };
  function hp(a, b) {
    var c,
  ...
  var Ep = K(ko, ["Document", "Placemark"]),
    ...
    Ip = K(ko, {
      Data: J(function (a, b, c) {
        ...
        "object" == typeof b
          ? (null !== b &&
              b.displayName &&
              zl(a, Ip, wl, [b.displayName], c, ["displayName"]),
            null !== b && b.value && zl(a, Ip, wl, [b.value], c, ["value"]))
          : zl(a, Ip, wl, [b], c, ["value"]);
      }),
    ...
    Lp = K(
      ko,
      { href: J(Mm) },
      K(jo, { x: J(Nm), y: J(Nm), w: J(Nm), h: J(Nm) })
    ),
    ...
    Pp = K(ko, ["color", "scale"]),
    Qp = K(ko, { color: J(ip), scale: J(Dp) }),
    Rp = K(ko, ["color", "width"]),
    Sp = K(ko, { color: J(ip), width: J(Nm) }),
    ...
    tp = K(ko, {
      ExtendedData: J(function (a, b, c) {
        ...
        for (var e = d.length, f = 0; f < e; f++)
          zl(a, Ip, Tp, [{ name: d[f], value: b[f] }], c);
      }),
      MultiGeometry: J(jp),
      LineString: J(wp),
      LinearRing: J(wp),
    ...
    Ap = K(ko, { outerBoundaryIs: J(pp), innerBoundaryIs: J(pp) }),
    Wp = K(ko, { color: J(ip) }),
  ...
  function kp(a, b) {
    if (a) return il(b[b.length - 1].node.namespaceURI, Jp[a.T()]);
  }
  var Xp = ul("color"),
    yp = ul("coordinates"),
    Tp = ul("Data"),
              ...
              f.write = function (a, b, d, e, f, n) {
                ...
                isNaN(b) || Infinity === b
                  ...
                  : ((e = Math.floor(Math.log(b) / Math.LN2)),
                    1 > b * (g = Math.pow(2, -e)) && (e--, (g *= 2)),
                    (b = 1 <= e + m ? b + p / g : b + p * Math.pow(2, 1 - m)),
                    2 <= b * g && (e++, (g /= 2)),
                    e + m >= l
                      ? ((b = 0), (e = l))
                      : 1 <= e + m
                      ? ((b = (b * g - 1) * Math.pow(2, f)), (e += m))
                      : ((b = b * Math.pow(2, m - 1) * Math.pow(2, f)),
                        (e = 0)));
          ...
          2: [
            function (a, b) {
              ...
              d.prototype = {
                ...
                zp: function (a) {
                  a &= 7;
                  if (a === d.c) for (; 127 < this.lc[this.ga++]; );
                  else if (a === d.b) this.ga = this.Ma() + this.ga;
                  else if (a === d.a) this.ga += 4;
                  else if (a === d.f) this.ga += 8;
      ...
      })(
        {
          ...
          3: [
            function (a, b) {
              function d(a, b, d) {
                3 === a &&
                  ((a = new e(d, d.Ma() + d.ga)), a.length && (b[a.name] = a));
              }
          ...
          4: [
            function (a, b) {
              ...
              function e(a, b, d) {
                ...
                else 3 == a ? (b.type = d.Ma()) : 4 == a && (b.tf = d.ga);
              }
              ...
              d.prototype.Ah = function () {
                ...
                a.ga = this.tf;
                for (
                  var b = a.Ma() + a.ga, d = 1, e = 0, f = 0, g = 0, v = [], x;
                  a.ga < b;
                  ...
                  if (
                    ...
                    (f += a.Yd()),
                      ...
                      1 === d && (x && v.push(x), (x = [])),
                      x.push(new h(f, g));
                  else if (7 === d) x && x.push(x[0].clone());
  ...
  k.D = function () {
    this.a ||
      (this.a =
        "Point" === this.f ? Wa(this.b) : Xa(this.b, 0, this.b.length, 2));
    return this.a;
  };
  k.fc = function () {
    return this.b;
      ...
      if (!c || -1 != c.indexOf(l)) {
        ...
        for (var m = 0, p = g.length; m < p; ++m) {
          if (f === Yp) {
            ...
            var y = n.type;
            1 === y
              ? (h = 1 === r.length ? "Point" : "MultiPoint")
              : 2 === y
              ? (h = 1 === r.length ? "LineString" : "MultiLineString")
              : 3 === y && (h = "Polygon");
            n = n.properties;
            n[this.a] = q;
            ...
            if (0 === r) n = null;
              ...
              $p(y, A, z);
              1 === r
                ? (n = 1 === y.length ? new E(null) : new O(null))
                : 2 === r
                ? 1 === y.length
                  ? (n = new M(null))
                  : (n = new N(null))
    ...
    fq = K(cq, {
      ...
      way: function (a, b) {
        for (
          ...
          ga(g, f.Eh[e.md[h]]);
        e.md[0] == e.md[e.md.length - 1]
          ? ((h = new F(null)), h.ca("XY", g, [g.length]))
          : ((h = new M(null)), h.ca("XY", g));
        Fl(h, !1, c);
        c = new H(h);
        c.kc(d);
        c.H(e.ae);
  ...
  aq.prototype.yc = function (a, b) {
    ...
    return "osm" == a.localName &&
      ((c = L({ Eh: {}, features: [] }, fq, a, [c])), c.features)
      ? c.features
      : [];
  };
  ...
  var kq = [null, "http://www.opengis.net/ows/1.1"],
    ...
    sq = K(kq, { Voice: I(Q), Facsimile: I(Q) }),
    wq = K(kq, {
      Constraint: sl(function (a, b) {
        var c = a.getAttribute("name");
        if (c) return L({ name: c }, rq, a, b);
      }),
    }),
    yq = K(kq, {
      IndividualName: I(Q),
    ...
    mq = K(kq, { Title: I(Q), ServiceTypeVersion: I(Q), ServiceType: I(Q) }),
    nq = K(kq, {
      ProviderName: I(Q),
      ProviderSite: I(gq),
  ...
  function Hq(a, b, c, d, e) {
    ...
    var f = [],
      ...
      h;
    g = 0;
    for (h = a.length; g < h; ++g) f[g] = Iq(a[g], b, c, d, e);
    return f;
  }
    ...
    if ("Topology" == a.type) {
      ...
      for (l = g.length; h < l; ++h)
        "GeometryCollection" === g[h].type
          ? ((m = g[h]), c.push.apply(c, Hq(m, f, d, e, b)))
          : ((m = g[h]), c.push(Iq(m, f, d, e, b)));
      return c;
    }
    return [];
  };
  ...
  var Jq = {
    ...
    Polygon: function (a, b) {
      var c = [],
        ...
        e;
      d = 0;
      for (e = a.arcs.length; d < e; ++d) c[d] = Gq(a.arcs[d], b);
      return new F(c);
    },
    MultiPoint: function (a, b, c) {
      a = a.coordinates;
      var d, e;
      if (b && c) for (d = 0, e = a.length; d < e; ++d) Kq(a[d], b, c);
      return new O(a);
    },
    ...
    MultiPolygon: function (a, b) {
      ...
      for (l = a.arcs.length; h < l; ++h) {
        ...
        e = [];
        f = 0;
        for (g = d.length; f < g; ++f) e[f] = Gq(d[f], b);
        c[h] = e;
      }
      return new P(c);
    },
  ...
  Lq.prototype.yc = function (a, b) {
    var c = { featureType: this.i, featureNS: this.a };
    pb(c, Dl(this, a, b ? b : {}));
    c = [c];
  ...
  Lq.prototype.j = function (a) {
    if (ll(a)) return Mq(a);
    if (ml(a)) return L({}, Nq, a, []);
    if ("string" === typeof a) return (a = nl(a)), Mq(a);
  };
  Lq.prototype.l = function (a) {
    if (ll(a)) return Oq(this, a);
    if (ml(a)) return Pq(this, a);
    if ("string" === typeof a) return (a = nl(a)), Oq(this, a);
  };
  function Oq(a, b) {
    for (var c = b.firstChild; c; c = c.nextSibling)
      if (c.nodeType == Node.ELEMENT_NODE) return Pq(a, c);
  }
  var Qq = {
    "http://www.opengis.net/gml": { boundedBy: I(Cm.prototype.We, "bounds") },
  };
  function Pq(a, b) {
    var c = {},
  ...
  function Mq(a) {
    for (a = a.firstChild; a; a = a.nextSibling)
      if (a.nodeType == Node.ELEMENT_NODE) return L({}, Nq, a, []);
  }
    ...
    "http://www.opengis.net/wfs": {
      ...
      Update: J(function (a, b, c) {
        ...
        if (void 0 !== e) {
          ...
          zl({ node: a, srsName: d.srsName }, Wq, ul("Property"), g, c);
          Vq(a, e);
        }
      }),
      ...
      Property: J(function (a, b, c) {
        ...
        void 0 !== b.value &&
          null !== b.value &&
          ((d = il("http://www.opengis.net/wfs", "Value")),
          a.appendChild(d),
          b.value instanceof cf
            ? Pm.prototype.zd(d, b.value, c)
            : Mm(d, b.value));
      }),
  ...
  var Yq = {
    "http://www.opengis.net/wfs": {
      Query: J(function (a, b, c) {
        ...
        if ((d = d.filter))
          (g = il("http://www.opengis.net/ogc", "Filter")),
            a.appendChild(g),
            zl({ node: g }, Yq, ul(d.Bc), [d], c);
      }),
    },
    "http://www.opengis.net/ogc": {
      And: J(Xq),
  ...
  Lq.prototype.qg = function (a) {
    for (a = a.firstChild; a; a = a.nextSibling)
      if (a.nodeType == Node.ELEMENT_NODE) return this.Ze(a);
    return null;
  };
  ...
  function fr(a) {
    var b = [];
    a = a.jd();
    for (var c = 0, d = a.length; c < d; ++c) b.push("(" + er(a[c]) + ")");
    return b.join(",");
  }
  function gr(a) {
    var b = a.T(),
  ...
  var hr = {
    ...
    MultiPolygon: function (a) {
      var b = [];
      a = a.Od();
      for (var c = 0, d = a.length; c < d; ++c) b.push("(" + fr(a[c]) + ")");
      return b.join(",");
    },
    GeometryCollection: function (a) {
      var b = [];
      a = a.If();
      for (var c = 0, d = a.length; c < d; ++c) b.push(gr(a[c]));
      return b.join(",");
    },
  };
  k = cr.prototype;
  ...
  k.Gg = function (a, b) {
    if (1 == a.length) return this.be(a[0], b);
  ...
  k.fg = function () {
    if (nr(this, 2)) {
      var a = sr(this);
      if (nr(this, 3)) return a;
    } else if (or(this)) return null;
    throw Error(pr(this));
  };
  k.eg = function () {
    if (nr(this, 2)) {
  ...
  k.uo = function () {
    if (nr(this, 2)) {
      var a;
      if (2 == this.b.type)
        for (a = [this.fg()]; nr(this, 5); ) a.push(this.fg());
      else a = tr(this);
      if (nr(this, 3)) return a;
    } else if (or(this)) return [];
    throw Error(pr(this));
  ...
  k.vo = function () {
    if (nr(this, 2)) {
      for (var a = [this.gg()]; nr(this, 5); ) a.push(this.gg());
      if (nr(this, 3)) return a;
    } else if (or(this)) return [];
    throw Error(pr(this));
  };
  ...
  function tr(a) {
    for (var b = [sr(a)]; nr(a, 5); ) b.push(sr(a));
    return b;
  }
  function ur(a) {
    for (var b = [a.eg()]; nr(a, 5); ) b.push(a.eg());
    return b;
  }
  function or(a) {
  ...
  var Er = [null, "http://www.opengis.net/wms"],
    ...
    Lr = K(Er, { ContactPerson: I(Q), ContactOrganization: I(Q) }),
    Mr = K(Er, {
      AddressType: I(Q),
      Address: I(Q),
      City: I(Q),
    ...
    Or = K(Er, { Title: I(Q), OnlineResource: I(gq), LogoURL: I(Br) }),
    Nr = K(Er, {
    ...
    yr = K(Er, { Format: I(Q), OnlineResource: I(gq) }),
  ...
  var Wr = [null, "http://www.opengis.net/wmts/1.0"],
    ...
    cs = K(Wr, { Default: I(Q), Value: sl(Q) }, K(Xr, { Identifier: I(Q) })),
    ds = K(Xr, { LowerCorner: ql(Vr), UpperCorner: ql(Vr) }),
    $r = K(
      Wr,
      {
      ...
      K(Xr, { SupportedCRS: I(Q), Identifier: I(Q) })
    ),
    gs = K(
      Wr,
      {
  ...
  k.im = function () {
    if (Od) {
      var a = this.Hh();
      a && void 0 === this.c
        ? (this.c = navigator.geolocation.watchPosition(
            this.Co.bind(this),
            this.Do.bind(this),
            this.th()
          ))
        : a ||
          void 0 === this.c ||
          (navigator.geolocation.clearWatch(this.c), (this.c = void 0));
    }
  };
  k.Co = function (a) {
    a = a.coords;
    ...
    this.set(
      "altitudeAccuracy",
      null === a.altitudeAccuracy ? void 0 : a.altitudeAccuracy
    );
    ...
    if (b < d) {
      if (b)
        for (
          ...
          c[d] = e[d];
      else for (d = 0; d < this.a; ++d) c[d] = e[d];
      c.length = this.a;
      return b;
    }
    return d;
  ...
  function ks(a, b, c) {
    for (
      ...
      (x = p.pop()),
        ...
        (r = a(z)),
        (v = b(r)),
        za(v[0], v[1], g[0], g[1], h[0], h[1]) < c
          ? (d.push(h[0], h[1]), (f = y.toString()), (n[f] = !0))
          : (p.push(y, z, z, x), m.push(h, v, v, g), l.push(f, r, r, e));
    return d;
  }
  ...
  var os = new rj({ color: "rgba(0,0,0,0.2)" }),
    ps = [
      90, 45, 30, 20, 10, 5, 2, 1, 0.5, 0.2, 0.1, 0.05, 0.01, 0.005, 0.002,
      0.001,
    ];
  ...
  k.wh = function (a) {
    ...
    f.a &&
      ((f = f.D()), (h = hb(f)), (c = c.focus[0]), c < f[0] || c > f[2]) &&
    ...
    b.Na(null, this.ta);
    a = 0;
    for (e = this.b.length; a < e; ++a) (g = this.b[a]), b.Qb(g, null);
    a = 0;
    for (e = this.a.length; a < e; ++a) (g = this.a[a]), b.Qb(g, null);
  };
  k.setMap = function (a) {
  ...
  k.nm = function () {
    void 0 === this.resolution &&
      (this.resolution = ib(this.extent) / this.M.height);
    this.state = 2;
    this.f.forEach(rc);
    this.f = null;
    this.s();
  ...
  function Fs(a) {
    return ng(a) && this.o(a)
      ? (Rf(a.map.$(), 1, 1), (this.a = this.g = void 0), !0)
      : !1;
  }
  function Is(a, b, c, d) {
    this.oa = a;
  ...
  function Ls(a, b, c, d, e, f, g, h, l) {
    ...
    a.qa && ia(d, a.eb)
      ? (m = a.qa)
      : (a.qa || (a.qa = []),
        (m = df(a.coordinates, 0, a.coordinates.length, 2, d, a.qa)),
        Ah(a.eb, d));
    d = !sb(f);
    for (
      var p = 0,
      ...
      switch (C[0]) {
        ...
        case 5:
          ...
          for ((Ra = C[10]) && (A += e); q < r; q += 2) {
            ...
            $d = $c.length;
            1 < $d
              ? ((Je = Math.round(1.5 * b.measureText("M").width)),
                (Ra -= (($d - 1) / 2) * Je))
              : (Je = 0);
            for (ue = 0; ue < $d; ue++)
              (Tc = $c[ue]),
                xb && b.strokeText(Tc, C, Ra),
                Ma && b.fillText(Tc, C, Ra),
                (Ra += Je);
            (1 != V || A) && b.setTransform.apply(b, x);
          }
          ++p;
        ...
        case 8:
          ...
          A = (C + 0.5) | 0;
          V = (Ra + 0.5) | 0;
          if (A !== y || V !== z) b.moveTo(C, Ra), (y = A), (z = V);
          for (q += 2; q < r; q += 2)
            if (
              ((C = m[q]),
              (Ra = m[q + 1]),
  ...
  k.Gf = function () {
    this.g ||
      ((this.g = Na(this.Y)),
      0 < this.c && Ka(this.g, (this.resolution * (this.c + 1)) / 2, this.g));
    return this.g;
  };
  function Rs(a) {
    var b = a.f,
    ...
    (b.Kd == c &&
      ...
      b.Id == h &&
      b.Jd == l) ||
      (b.Sf != a.coordinates.length &&
        (a.a.push([12]), (b.Sf = a.coordinates.length)),
  ...
  k.nc = function (a, b) {
    ...
    if (void 0 !== c.strokeStyle && void 0 !== d) {
      ...
      var c = a.Rb(),
        ...
        h;
      g = 0;
      for (h = c.length; g < h; ++g) f = Qs(this, d, f, c[g], e);
      this.b.push([12]);
      Ns(this, b);
    }
  };
  ...
  k.pc = function (a, b) {
    ...
    if (void 0 !== c.fillStyle || void 0 !== d) {
      ...
      var c = a.c,
        ...
        h;
      g = 0;
      for (h = c.length; g < h; ++g) f = Ts(this, d, f, c[g], e);
      Ns(this, b);
    }
  };
  k.Je = function () {
  ...
  k.Na = function (a, b) {
    ...
    b
      ? ((d = b.a),
        (c.strokeStyle = Vc(d ? d : Ph)),
        (d = b.i),
        (c.lineCap = void 0 !== d ? d : "round"),
        (d = b.f),
        (c.lineDash = d ? d.slice() : Oh),
        (d = b.g),
        (c.lineDashOffset = d ? d : 0),
        (d = b.l),
        ...
        c.lineWidth > this.c && ((this.c = c.lineWidth), (this.g = null)))
    ...
    if ("" !== this.Fa && this.l && (this.f || this.g)) {
      if (this.f) {
        ...
        if (!g || g.fillStyle != e.fillStyle) {
          ...
          this.b.push(h);
          g
            ? (g.fillStyle = e.fillStyle)
            : (this.A = { fillStyle: e.fillStyle });
        }
      }
      this.g &&
        ((e = this.g),
      ...
      (g &&
        ...
        ((h = [11, e.font, e.textAlign, e.textBaseline]),
        this.a.push(h),
        this.b.push(h),
        g
          ? ((g.font = e.font),
  ...
  Vs.prototype.Tb = function (a) {
    if (a) {
      ...
      b
        ? ((b = b.b),
          (b = Vc(b ? b : Nh)),
          this.f ? (this.f.fillStyle = b) : (this.f = { fillStyle: b }))
        : (this.f = null);
      var c = a.Da();
      if (c) {
        var b = c.a,
      ...
      l = void 0 !== l ? l : "middle";
      this.l
        ? ((m = this.l), (m.font = a), (m.textAlign = g), (m.textBaseline = l))
        : (this.l = { font: a, textAlign: g, textBaseline: l });
      this.Fa = void 0 !== f ? f : "";
      this.j = void 0 !== b ? b : 0;
      this.o = void 0 !== d ? d : 0;
      this.v = void 0 !== e ? e : !1;
  ...
  Ws.prototype.Aa = function (a, b, c, d, e, f) {
    d = Math.round(d);
    var g = 2 * d + 1,
      h = Fh(this.j, d + 0.5, d + 0.5, 1 / b, -1 / b, -c, -a[0], -a[1]),
      l = this.l;
  ...
  Ws.prototype.b = function (a, b) {
    ...
    c = d[b];
    void 0 === c &&
      ((c = new ct[b](this.I, this.c, this.v, this.o)), (d[b] = c));
    return c;
  };
  ...
  function at(a, b, c, d, e, f, g) {
    ...
    for (m = h.length; l < m; ++l)
      for (n = a.a[h[l].toString()], p = ei.length - 1; 0 <= p; --p)
        if (
          ((q = n[ei[p]]),
          void 0 !== q && (q = Ls(q, b, 1, c, d, e, q.b, f, g)))
        )
          return q;
  }
  var ct = { Circle: Ss, Image: Os, LineString: Ps, Polygon: Ss, Text: Vs };
  function dt(a) {
    Fc.call(this);
    this.a = a;
  }
  ...
  function jt(a, b) {
    ...
    void 0 !== c &&
      ("string" === typeof c
        ? (a.logos[c] = "")
        : c &&
          (qa("string" == typeof c.href, 44),
          qa("string" == typeof c.src, 45),
        ...
        for (z = v.fa; z <= v.ja; ++z)
          g - A <= h
            ? ((r = b.Lc(A, y, z, d, e)),
              0 == r.V() &&
                ((n[r.ib()] = !0),
                r.ib() in a.a || a.i([r, p, ic(c, r.Ga), x])),
              l && l.call(m, r))
            : b.Eg(A, y, z, e);
  }
  function mt(a) {
  ...
  function ot(a, b, c, d, e) {
    ...
    if (Ec(f, b)) {
      ...
      f.b(
        new Mh(
          b,
          new Sh(c, d.pixelRatio, d.extent, a, d.viewState.rotation),
          d,
          c,
          null
        )
  ...
  mt.prototype.v = function (a, b, c, d) {
    if (this.Aa(a, b, 0, af, this)) return c.call(d, this.a, null);
  };
  ...
  function st(a, b, c, d, e, f) {
    ...
    if ((h = c.Z()))
      (l = h.Oe()),
        2 == l || 3 == l
          ? h.Yi(e, f)
          : (0 == l && h.load(), h.zh(e, f), (g = !0));
    if ((e = (0, c.Ra)(b))) (d = e.Qd(d)), (0, tt[d.T()])(a, d, c, b);
    return g;
  }
  var tt = {
    ...
    GeometryCollection: function (a, b, c, d) {
      ...
      var e, f;
      e = 0;
      for (f = b.length; e < f; ++e) (0, tt[b[e].T()])(a, b[e], c, d);
    },
  ...
  ut.prototype.I = function (a, b, c) {
    ...
    if ((n = this.i) && !n.f()) {
      ...
      Qh(x, g, z / 2, A / 2);
      x != c &&
        (ot(this, "render", x, a, p),
        c.drawImage(x.canvas, -r, -v),
        x.translate(-r, -v));
      x.globalAlpha = y;
    }
    q && c.restore();
  ...
  ut.prototype.qd = function (a) {
    function b(a) {
      ...
      if (b) {
        if (b) {
          ...
          else d = st(q, a, b, rt(m, p), this.A, this) || d;
          a = d;
        } else a = !1;
        this.c = this.c || a;
      }
    ...
    d.G &&
      h.projection.a &&
      !Ta(n, a.extent) &&
      ((a = Math.max(hb(l) / 2, hb(n))), (l[0] = n[0] - a), (l[2] = n[2] + a));
  ...
  k.Zf = function (a, b, c, d) {
    a = Bh(b.pixelToCoordinateTransform, a.slice());
    if (this.Ke(a, b)) return c.call(d, this.a, null);
  };
  k.bi = function () {
    ft(this);
  };
    ...
    function d(a) {
      ...
      if (b) {
        if (b) {
          ...
          else c = st(q, a, b, rt(m, p), this.bi, this) || c;
          a = c;
        } else a = !1;
        this.o = this.o || a;
      }
  ...
  u(Gt, Gc);
  function Ht(a) {
    if ("string" === typeof a) return [new nc({ html: a })];
  ...
  function S(a) {
    ...
    a.loader
      ? (this.Y = a.loader)
      : void 0 !== this.ea && (qa(this.S, 7), (this.Y = Bl(this.ea, this.S)));
  ...
  function Jt(a, b) {
    ...
    a.a && a.a.load(g, l);
    d = 0;
    for (e = h.length; d < e; d++) a.b(new Nt("addfeature", h[d]));
  }
  function Kt(a, b) {
    var c = !1;
  ...
  k.clear = function (a) {
    if (a) {
      for (var b in this.v) this.v[b].forEach(rc);
      this.i || ((this.v = {}), (this.j = {}), (this.o = {}));
    } else if (this.a) {
      this.a.forEach(this.ug, this);
      for (var c in this.g) this.ug(this.g[c]);
    }
    this.i && this.i.clear();
    this.a && this.a.clear();
    this.oa.clear();
  ...
  k.ac = function (a, b, c) {
    if (this.a) return Jj(this.a, a, b, c);
    if (this.i) return this.i.forEach(b, c);
  };
  k.dh = function (a, b, c) {
    return this.ac(a, function (d) {
      if (d.U().Xa(a) && (d = b.call(c, d))) return d;
    });
  };
  k.lh = function () {
    return this.i;
  ...
  k.Ne = function () {
    ...
    this.i
      ? (a = this.i.a)
      : this.a && ((a = Gj(this.a)), sb(this.g) || ga(a, rb(this.g)));
    return a;
  };
  k.kh = function (a) {
    var b = [];
  ...
  k.ji = function (a) {
    ...
    c
      ? ((c = c.D()),
        b in this.g
          ? (delete this.g[b], this.a && this.a.Ea(c, a))
          : this.a && Fj(this.a, c, a))
      : b in this.g || (this.a && this.a.remove(a), (this.g[b] = a));
    c = a.a;
    void 0 !== c
      ? ((c = c.toString()),
        b in this.o
          ? (delete this.o[b], (this.j[c] = a))
          : this.j[c] !== a && (Pt(this, a), (this.j[c] = a)))
      : b in this.o || (Pt(this, a), (this.o[b] = a));
    this.s();
  ...
  u(Nt, Bc);
  function Qt(a) {
    pg.call(this, { handleDownEvent: Rt, handleEvent: St, handleUpEvent: Tt });
    this.ea = null;
    this.u = !1;
  ...
  function Rt(a) {
    return this.u
      ? ((this.ea = a.pixel), this.o || au(this, a), !0)
      : this.Yj(a)
      ? ((this.ea = a.pixel), !0)
      : !1;
  }
  ...
  function $t(a, b) {
    if (a.o) {
      ...
      a.g === Wt
        ? (e = a.a)
        : a.g === Vt
        ? ((e = a.a[0]), (e = e[e.length - 1]), cu(a, b) && (c = a.o.slice()))
        : ((e = a.a), (e = e[e.length - 1]));
      e[0] = c[0];
      e[1] = c[1];
      a.Ra(a.a, d);
      a.G && a.G.U().pa(c);
      d instanceof F && a.g !== Vt
        ? (a.C || (a.C = new H(new M(null))),
          (d = d.nh(0)),
          (c = a.C.U()),
          c.ca(d.ka, d.ha()))
        : a.R && ((c = a.C.U()), c.pa(a.R));
      du(a);
    } else (c = b.coordinate.slice()), a.G ? a.G.U().pa(c) : ((a.G = new H(new E(c))), du(a));
    return !0;
  }
  function cu(a, b) {
    var c = !1;
  ...
  function au(a, b) {
    ...
    a.g === Wt
      ? (a.a = c.slice())
      : a.g === Vt
      ? ((a.a = [[c.slice(), c.slice()]]), (a.R = a.a[0]))
      : ((a.a = [c.slice(), c.slice()]), a.g === bu && (a.R = a.a));
  ...
  k.cp = function () {
    var a = this.j.U(),
      ...
      c;
    this.g === Xt
      ? ((b = this.a), b.splice(-2, 1), this.Ra(b, a))
      : this.g === Vt &&
        ((b = this.a[0]),
        b.splice(-2, 1),
        (c = this.C.U()),
  ...
  k.Nd = function () {
    ...
    this.g === Xt
      ? (b.pop(), this.Ra(b, c))
      : this.g === Vt && (b[0].pop(), this.Ra(b, c), (b = c.X()));
    "MultiPoint" === this.S
      ? a.Sa(new O([b]))
      : "MultiLineString" === this.S
      ? a.Sa(new N([b]))
      : "MultiPolygon" === this.S && a.Sa(new P([b]));
    ...
    (a = nu(this, c, d)) && e
      ? ((c = a[0] == e[0] || a[0] == e[2] ? a[0] : null),
        ...
        null !== c && null !== d
          ? (this.a = pu(b(a)))
          : null !== c
          ? (this.a = qu(b([c, e[1]]), b([c, e[3]])))
          : null !== d && (this.a = qu(b([e[0], d]), b([e[2], d]))))
      : ((a = d.Za(c)), this.g([a[0], a[1], a[0], a[1]]), (this.a = pu(a)));
    return !0;
  }
  function iu(a) {
  ...
  gu.prototype.g = function (a) {
    ...
    b
      ? a
        ? b.Sa(Nf(a))
        : b.Sa(void 0)
      : ((this.o = b = a ? new H(Nf(a)) : new H({})), this.u.la().zb(b));
  ...
  k.Tm = function (a, b) {
    ...
    for (f = c.length; e < f; ++e)
      (d = c[e]),
        (d = { feature: a, geometry: b, depth: [e], index: e, na: [d, d] }),
        this.a.Ea(b.D(), d);
  };
  k.Oh = function (a, b) {
    var c = b.X(),
    ...
    for (e = c.length - 1; d < e; ++d)
      (f = c.slice(d, d + 2)),
        (g = { feature: a, geometry: b, index: d, na: f }),
        this.a.Ea(Ha(f), g);
  };
  k.Sm = function (a, b) {
    var c = b.X(),
    ...
    for (h = c.length; g < h; ++g)
      for (d = c[g], e = 0, f = d.length - 1; e < f; ++e)
        (l = d.slice(e, e + 2)),
          (m = { feature: a, geometry: b, depth: [g], index: e, na: l }),
          this.a.Ea(Ha(l), m);
  };
  k.Wm = function (a, b) {
    var c = b.X(),
    ...
    for (m = c.length; l < m; ++l)
      for (p = c[l], g = 0, h = p.length; g < h; ++g)
        for (d = p[g], e = 0, f = d.length - 1; e < f; ++e)
          (n = d.slice(e, e + 2)),
            (q = { feature: a, geometry: b, depth: [g, l], index: e, na: n }),
            this.a.Ea(Ha(n), q);
  };
  k.Ip = function (a, b) {
    var c = b.Ba(),
      d = { feature: a, geometry: b, index: 0, na: [c, c] },
      e = { feature: a, geometry: b, index: 1, na: [c, c] };
    d.Ef = e.Ef = [d, e];
    this.a.Ea(Wa(c), d);
    this.a.Ea(b.D(), e);
  };
  k.Rm = function (a, b) {
    var c,
      d = b.a;
    for (c = 0; c < d.length; ++c) this.ea[d[c].T()].call(this, a, d[c]);
  };
  function Eu(a, b) {
    var c = a.g;
    ...
    if (b) {
      ...
      for (var f = 0, g = d.length; f < g; ++f) {
        ...
        if ("Circle" === h.geometry.T() && 1 === h.index)
          (l = Gu(b, h)),
            Ue(l, b) && !e[m][0] && (this.j.push([h, 0]), (e[m][0] = h));
        else if (Ue(l[0], b) && !e[m][0]) this.j.push([h, 0]), (e[m][0] = h);
        else if (Ue(l[1], b) && !e[m][1]) {
          if (
            ("LineString" !== h.geometry.T() &&
              "MultiLineString" !== h.geometry.T()) ||
            !e[m][0] ||
            0 !== e[m][0].index
          )
            this.j.push([h, 1]), (e[m][1] = h);
        } else w(l) in this.Ha && !e[m][0] && !e[m][1] && c.push([h, b]);
      }
      c.length && Au(this, a);
      for (a = c.length - 1; 0 <= a; --a) this.Il.apply(this, c[a]);
    }
    return !!this.g;
  }
  function vu(a) {
  ...
  function wu(a) {
    ...
    ld(a.map.$())[1] ||
      "pointermove" != a.type ||
      this.A ||
      ((this.Ja = a.pixel), zu(this, a.pixel, a.map));
    this.g &&
      this.lb(a) &&
      (b = "singleclick" == a.type && this.R ? !0 : this.Ci());
  ...
  function zu(a, b, c) {
    ...
    if (0 < f.length) {
      ...
      if (p <= a.ia) {
        b = {};
        if ("Circle" === g.geometry.T() && 1 === g.index) (a.oa = !0), Eu(a, l);
        else
          for (
            p = c.Ka(h[0]),
              g = c.Ka(h[1]),
            ...
            if (
              ((l = f[m].na),
              (Ue(h[0], l[0]) && Ue(h[1], l[1])) ||
                (Ue(h[0], l[1]) && Ue(h[1], l[0])))
            )
              b[w(l)] = !0;
            else break;
        b[w(h)] = !0;
  ...
  k.Il = function (a, b) {
    for (
      var c = a.na, d = a.feature, e = a.geometry, f = a.depth, g = a.index, h;
      b.length < e.sa();
    ...
    if (this.S && "pointerdrag" != this.S.type) {
      ...
      for (n in c) {
        ...
        d &&
          ...
          (this.o = !1),
          (f = []),
          void 0 !== h && (this.a.remove(h), f.push(h.na[0])),
          void 0 !== m && (this.a.remove(m), f.push(m.na[1])),
          void 0 !== h &&
            void 0 !== m &&
            ((h = {
              depth: p.depth,
            ...
            this.a.Ea(Ha(h.na), h)),
          Iu(this, b, g, p.depth, -1),
          this.g && (this.G.la().Db(this.g), (this.g = null)));
      }
  ...
  function Iu(a, b, c, d, e) {
    Jj(a.a, b.D(), function (a) {
      a.geometry === b &&
        (void 0 === d || void 0 === a.depth || ia(a.depth, d)) &&
        a.index > c &&
        (a.index += e);
    });
  }
  ...
  function Ku(a) {
    ...
    if (e) {
      ...
      f.re(
        ...
        { layerFilter: this.u, hitTolerance: this.l }
      );
      for (e = g.ec() - 1; 0 <= e; --e) {
        var f = g.item(e),
          m = l.indexOf(f);
        ...
        function (a, e) {
          if (this.j(a, e)) {
            if ((!b && !d) || ea(g.a, a))
              (c || d) &&
                ea(g.a, a) &&
                (h.push(a), (f = w(a)), delete this.a[f]);
            else {
              l.push(a);
              var f = w(a);
              this.a[f] = e;
  ...
  var Nu = "select";
  function Ou(a) {
    pg.call(this, { handleEvent: Pu, handleDownEvent: af, handleUpEvent: Qu });
    a = a ? a : {};
  ...
  k.setMap = function (a) {
    ...
    a &&
      (this.j
        ? c.push(
            B(this.j, "add", this.Ph, this),
            B(this.j, "remove", this.Qh, this)
          )
        : this.o &&
          c.push(
            B(this.o, "addfeature", this.Ph, this),
            B(this.o, "removefeature", this.Qh, this)
          ),
      d.forEach(this.ek, this));
  };
  k.Zc = bf;
  k.$i = function (a) {
    this.Db(a, !1);
  ...
  k.Rh = function (a, b) {
    ...
    d = 0;
    for (e = c.length - 1; d < e; ++d)
      (f = c.slice(d, d + 2)), (g = { feature: a, na: f }), this.a.Ea(Ha(f), g);
  };
  k.en = function (a, b) {
    var c = b.X(),
      d,
  ...
  k.fn = function (a, b) {
    ...
    e = 0;
    for (f = c.length; e < f; ++e)
      (d = c[e]), (d = { feature: a, na: [d, d] }), this.a.Ea(b.D(), d);
  };
  k.gn = function (a, b) {
    var c = b.X(),
      d,
  ...
  function Vu(a) {
    ...
    Xu(this, a.pixel, a.map)
      ? ((this.g = void 0 !== this.g ? this.g : b.style.cursor),
        (b.style.cursor = this.a ? "-webkit-grabbing" : "-webkit-grab"),
        (b.style.cursor = this.a ? "grabbing" : "grab"))
      : void 0 !== this.g && ((b.style.cursor = this.g), (this.g = void 0));
  }
  function Xu(a, b, c) {
    return c.re(
      b,
      function (a) {
        if (!this.o || ea(this.o.a, a)) return a;
      }.bind(a),
    ...
    this.g(
      function (a) {
        ...
        var b = (255 * a) | 0,
          c = this.R[b];
        c ||
          ((c = [new $k({ image: new Rn({ opacity: a, src: this.S }) })]),
          (this.R[b] = c));
        return c;
      }.bind(this)
    );
  ...
  cv.prototype.v = function (a, b, c, d) {
    if (this.Z()) {
      if (this.a.la().Aa !== na) return mt.prototype.v.apply(this, arguments);
  ...
  dv.prototype.qd = function (a, b) {
    ...
    l[0] ||
      l[1] ||
      gb(m) ||
      ((e = h.Z(m, g, c, e.projection)) && gt(this, e) && (this.M = e));
    if (this.M) {
      var e = this.M,
        m = e.D(),
        p = e.resolution,
      ...
      if (
        ...
        Math.abs(b[0] - d[0]) <= Math.abs(b[1] - d[1])
          ? ((r = [(c[0] + d[0]) / 2, (c[1] + d[1]) / 2]),
            ...
            (n = a.a(p)),
            iv(a, b, c, r, p, f, g, q, n, m - 1),
            iv(a, p, r, d, e, n, q, h, l, m - 1))
          : ((r = [(b[0] + c[0]) / 2, (b[1] + c[1]) / 2]),
            (q = a.a(r)),
            (p = [(d[0] + e[0]) / 2, (d[1] + e[1]) / 2]),
            (n = a.a(p)),
            iv(a, b, r, p, e, f, q, n, l, m - 1),
            iv(a, r, c, d, p, q, g, h, n, m - 1));
        return;
      }
      if (r) {
        if (!a.o) return;
  ...
  kv.prototype.Zd = function () {
    ...
    2 == a &&
      (this.g = gv(
        ...
        this.f,
        this.l,
        [{ extent: this.Eb.D(), image: this.Eb.Z() }],
        0
      ));
    this.state = a;
    this.s();
    ...
    if (0 == this.state) {
      ...
      2 == a || 3 == a
        ...
        : ((this.$d = B(
            ...
            function () {
              var a = this.Eb.V();
              if (2 == a || 3 == a) rc(this.$d), (this.$d = null), this.Zd();
            },
            this
          )),
          this.Eb.load());
  ...
  sv.prototype.Ic = function (a, b, c, d) {
    ...
    a = a.slice();
    nb(a, this.oa);
    (d = this.ia(a, b, c, [(hb(a) / b) * c, (ib(a) / b) * c], d)) &&
      (e = new us(a, b, c, this.l, d));
    this.S = e;
    this.Y = this.f;
    return e;
  };
  ...
  k.Zj = function (a, b, c, d, e) {
    ...
    $s(f);
    if (g) return null;
    this.o[0] != d[0] || this.o[1] != d[1]
      ? ((this.g.canvas.width = d[0]),
        (this.g.canvas.height = d[1]),
        (this.o[0] = d[0]),
        (this.o[1] = d[1]))
      : this.g.clearRect(0, 0, d[0], d[1]);
  ...
  vv.prototype.ag = function (a, b) {
    ...
    l &&
      ((c = this.c.i.l),
      xv(this, c.width, c.height, d, f, g, h, l.D()),
      (this.j = null),
      (d = this.v),
      xh(d),
      Dh(d, 1, -1),
  ...
  vv.prototype.Zf = function (a, b, c, d) {
    if (this.M && this.M.Z())
      if (this.a.la() instanceof tv) {
        ...
        if (this.Aa(e, b, 0, af, this)) return c.call(d, this.a, null);
      } else {
        ...
        if (
          ...
          (this.i || (this.i = Xc(1, 1)),
          this.i.clearRect(0, 0, 1, 1),
          this.i.drawImage(this.M.Z(), a[0], a[1], 1, 1, 0, 0, 1, 1),
  ...
  zv.prototype.qd = function (a, b) {
      ...
      for (xb = x.fa; xb <= x.ja; ++xb)
        (C = l.Lc(n, Ma, xb, c, f)),
          ...
          Av(this, C)
            ? 2 == C.V() &&
              ((A[n][C.Ga.toString()] = C),
              La || -1 != this.c.indexOf(C) || (La = !0))
            : ec(p, C.Ga, V, ra, Pa) ||
              ((C = fc(p, C.Ga, ra, Pa)) && V(n + 1, C));
    V = a.viewHints;
    if (
      !(
        (this.i && 16 < Date.now() - a.time && (V[0] || V[1])) ||
        (!La && this.l && Ta(this.l, v) && this.af == m)
      ) ||
      r != this.R
    ) {
      La = l.Sd(n, c, f);
      ...
      xb = La.canvas;
      V = l.Mf(f);
      xb.width != Ma || xb.height != C
        ? ((this.R = r), (xb.width = Ma), (xb.height = C))
        : (La.clearRect(0, 0, Ma, C), (r = this.R));
      this.c.length = 0;
      ...
      for (dc = ra.length; Cb < dc; ++Cb) {
        ...
        for (var Tc in $d)
          (C = $d[Tc]),
            ...
            (Je = (Ra[0] * Z) / r),
            (ue = (Ra[1] * Z) / r),
            V || La.clearRect(Ma, xb, Je, ue),
            this.Df(C, a, b, Ma, xb, Je, ue, $c),
            this.c.push(C);
      }
      this.af = m;
      this.i = ((q * c) / z) * r;
    ...
    Tc = Fh(
      ...
      Tc,
      0,
      ((this.l[0] - e[0]) / this.i) * c,
      ((e[1] - this.l[3]) / this.i) * c
    );
    Fh(
      this.o,
      (c * d[0]) / 2 - Tc[4],
  ...
  zv.prototype.Df = function (a, b, c, d, e, f, g, h) {
    (a = a.Z()) &&
      this.u.drawImage(a, h, h, a.width - 2 * h, a.height - 2 * h, d, e, f, g);
  };
  ...
  k.ag = function (a, b, c) {
    var d = this.c,
      ...
      z = a.extent,
      A = gc(m, z, n);
    if (this.j && ua(this.j, A) && this.o == l.f) v = this.A;
    else {
      ...
      b.sort(da);
      for (
        var C = new Float32Array(4), dc, Ma = 0, xb = b.length;
        Ma < xb;
        ++Ma
      )
        for (dc in ((Ra = c[b[Ma]]), Ra))
          (ra = Ra[dc]),
            ...
            (C[2] = (2 * (Z[0] - v[0])) / V - 1),
            (C[3] = (2 * (Z[1] - v[1])) / V - 1),
            e.uniform4fv(this.i.c, C),
            lk(d, ra, q, x * r),
            e.drawArrays(5, 0, 4);
      Pa
        ? ((this.j = A), (this.A = v), (this.o = l.f))
        : ((this.A = this.j = null), (this.o = -1), (a.animate = !0));
    }
    ...
    lt(
      ...
      function (a) {
        2 != a.V() ||
          d.a.b.hasOwnProperty(a.ib()) ||
          a.ib() in $c.a ||
          $c.i([a, ic(m, a.Ga), m.La(a.Ga[0]), q, x * r]);
      },
      this
    );
    ht(a, l);
    ...
    Eh(
      e,
      (Math.round(y[0] / n) * n - v[0]) / (v[2] - v[0]),
      (Math.round(y[1] / n) * n - v[1]) / (v[3] - v[1])
    );
    f.rotation && Ch(e, f.rotation);
    Dh(
      e,
      (a.size[0] * f.resolution) / (v[2] - v[0]),
      (a.size[1] * f.resolution) / (v[3] - v[1])
    );
    Eh(e, -0.5, -0.5);
    return !0;
  };
  ...
  u(Iv, zv);
  var Jv = { image: ei, hybrid: ["Polygon", "LineString"] },
    Kv = { hybrid: ["Image", "Text"], vector: ei };
  k = Iv.prototype;
  k.qd = function (a, b) {
    var c = this.a.f;
    ...
    function d(a) {
      ...
      if (b) {
        ...
        if (b) {
          ...
          else f = st(d, a, b, c, this.$h, this) || f;
          a = f;
        } else a = !1;
        this.G = this.G || a;
        l.Ld = l.Ld || a;
  ...
  k.Aa = function (a, b, c, d, e) {
    ...
    for (v = l.length; r < v; ++r)
      (y = l[r]),
        (q = y.Ga),
        (x = m.tileGrid.Ta(q, this.j)),
        Qa(Ka(x, c * f), a) &&
          ("tile-pixels" === y.l.Jb()
            ? ((x = eb(x)),
              (f = m.pb()),
              (q = p.La(q[0]) / f),
              (q = [(a[0] - x[0]) / q, (x[1] - a[1]) / q]))
            : (q = a),
          (y = y.f.vd),
          (n =
            n ||
            y.Aa(q, f, b, c, {}, function (a) {
              var b = w(a).toString();
  ...
  function Pv(a, b, c, d, e, f, g, h, l, m, p) {
    ...
    if (fb(f))
      if (
        ((h = a.D()) && (e ? (e = lb(e, h)) : (e = h)),
        (d = ev(a, c, jb(f), d.La(this.o[0]))),
        !isFinite(d) || 0 >= d)
      )
        this.state = 4;
      else if (
        ((this.v = new hv(a, c, f, e, d * (void 0 !== m ? m : 0.5))),
        this.v.c.length)
      )
        if (
          ((this.g = b.Mc(d)),
          ...
          e &&
            (a.a
              ? ((c[1] = wa(c[1], e[1], e[3])), (c[3] = wa(c[3], e[1], e[3])))
              : (c = lb(c, e))),
          fb(c))
        ) {
          a = cc(b, c, this.g);
  ...
  Pv.prototype.Zd = function () {
    ...
    this.f.forEach(function (b) {
      b && 2 == b.V() && a.push({ extent: this.c.Ta(b.Ga), image: b.Z() });
    }, this);
    this.f.length = 0;
    if (a.length) {
      var b = this.o[0],
          ...
          d = B(
            ...
            function () {
              ...
              if (2 == c || 3 == c || 4 == c)
                rc(d),
                  a--,
                  a || (this.wd.forEach(rc), (this.wd = null), this.Zd());
            },
            this
          );
          this.wd.push(d);
  ...
  Vv.prototype.gd = function (a) {
    for (var b, c; Wv(this); ) {
      ...
      c = b.Ga[0].toString();
      var d;
      if ((d = c in a)) (b = b.Ga), (d = ta(a[c], b[1], b[2]));
      if (d) break;
      else Ac(this.pop());
    }
  };
  ...
  k.Ib = function (a) {
    var b = this.c;
    return !this.tileGrid || (b && !Tb(b, a))
      ? ((b = w(a).toString()), b in this.v || (this.v[b] = jc(a)), this.v[b])
      : this.tileGrid;
  };
  k.Rd = function (a) {
    var b = this.c;
    if (!b || Tb(b, a)) return this.a;
    a = w(a).toString();
    ...
    if (
      ...
      var e = mc({
        ...
        tileSize:
          (c.imageWidth == c.imageHeight
            ? c.imageWidth
            : [c.imageWidth, c.imageHeight]) / this.pb(),
      });
      this.tileGrid = e;
      var f = this.S,
        g = this.A;
      this.tileUrlFunction = Sv(
      ...
      if (c.imageryProviders) {
        ...
        a = c.imageryProviders.map(function (a) {
          ...
          return new nc({ html: b, tileRanges: c });
        });
        a.push(fw);
        this.ua(a);
      }
  ...
  function kw(a) {
    if (void 0 !== a.C) {
      a.A.length = 0;
      for (
        var b = Ia(), c = a.ia * a.C, d = a.u.Ne(), e = {}, f = 0, g = d.length;
        f < g;
        f++
      ) {
        var h = d[f];
  ...
  function ow(a) {
    lv.call(this, { projection: a.projection, resolutions: a.resolutions });
    this.S = void 0 !== a.crossOrigin ? a.crossOrigin : null;
          ...
          2: [
            function (a, b) {
                  ...
                  if (d.imageOps) {
                    ...
                    for (d = 0; d < l; ++d) {
                      ...
                      var La = g,
                        C = h;
                      q = b
                        ? new ImageData(q, La, C)
                        : { data: q, width: La, height: C };
                      n[p] = q;
                    }
                    g = a(m, f).data;
                  } else {
              ...
              function l(a) {
                ...
                else d[0] = h(a, this.Qg.bind(this, 0));
                this.le = d;
                this.Cd = [];
              ...
              l.prototype.Ng = function () {
                if (0 === this.je && 0 < this.Cd.length) {
                  ...
                  if (1 === f)
                    ...
                    for (
                      var g = 4 * Math.ceil(a.inputs[0].data.length / 4 / f),
                        h = 0;
                      h < f;
                      ++h
                    ) {
                      for (
                        var l = h * g, m = [], V = 0, Pa = e.length;
                        V < Pa;
                        ++V
                      )
              ...
              l.prototype.Nj = function () {
                var a = this.vf,
                  ...
                  e;
                if (1 === b)
                  (d = new Uint8ClampedArray(this.cd[0].buffer)),
                    (e = this.cd[0].meta);
                else {
  ...
  ww.prototype.Z = function (a, b, c, d) {
    ...
    this.v = { extent: a, resolution: b, kp: this.f };
    return d;
  };
  ww.prototype.S = function (a, b) {
    ...
    d &&
      ...
      this.C.Eo(d, c, this.oa.bind(this, a, b)));
  ...
  ww.prototype.oa = function (a, b, c, d, e) {
    c
      ? b(c)
      : d &&
        (this.b(new Bw(Dw, a, e)),
        zw(this, a.extent, a.viewState.resolution / a.pixelRatio) ||
  ...
  function xw(a) {
    for (var b = a.length, c = Array(b), d = 0; d < b; ++d) {
      var e = d,
        ...
        g = null;
      f instanceof Xv
        ? ((f = new Hv({ source: f })), (g = new zv(f)))
        : f instanceof lv && ((f = new yv({ source: f })), (g = new dv(f)));
      c[e] = g;
    }
    return c;
  }
  ...
  var Hw = [
    ...
    Gw = {
      terrain: { Hb: "jpg", opaque: !0 },
      "terrain-background": { Hb: "jpg", opaque: !0 },
      "terrain-labels": { Hb: "png", opaque: !1 },
      "terrain-lines": { Hb: "png", opaque: !1 },
      "toner-background": { Hb: "png", opaque: !0 },
      toner: { Hb: "png", opaque: !0 },
      "toner-hybrid": { Hb: "png", opaque: !1 },
      "toner-labels": { Hb: "png", opaque: !1 },
      "toner-lines": { Hb: "png", opaque: !1 },
      "toner-lite": { Hb: "png", opaque: !0 },
      watercolor: { Hb: "jpg", opaque: !0 },
    },
    Fw = {
    ...
    if (!(d.b.length <= a[0])) {
      ...
      g
        ? ((c = c.nb.split(":").pop()),
          ...
          (a = (1 == g.length ? g[0] : g[Ca((a[1] << a[0]) + a[2], g.length)])
            .replace(/MapServer\/?$/, "MapServer/export")
            .replace(/ImageServer\/?$/, "ImageServer/exportImage")),
          (a = mw(a, d)))
        : (a = void 0);
  ...
  function Mw(a) {
    ...
    if (a.jsonp) Ov(a.url, this.di.bind(this), this.Le.bind(this));
    else {
  ...
  k.di = function (a) {
    ...
    var f = a.minzoom || 0,
      e = a.maxzoom || 22;
    this.tileGrid = c = mc({ extent: kc(c), maxZoom: e, minZoom: f });
    this.tileUrlFunction = Rv(a.tiles, c);
    if (void 0 !== a.attribution && !this.l) {
      b = void 0 !== d ? d : b.D();
      d = {};
      for (var g; f <= e; ++f) (g = f.toString()), (d[g] = [cc(c, b, f)]);
      this.ua([new nc({ html: a.attribution, tileRanges: d })]);
    }
    this.i = a;
    It(this, "ready");
  };
  ...
  function Nw(a) {
    Xv.call(this, { projection: Gb("EPSG:3857"), state: "loading" });
    this.v = void 0 !== a.preemptive ? a.preemptive : !0;
    this.o = Tv;
    this.g = void 0;
    this.i = a.jsonp || !1;
    if (a.url)
      if (this.i) Ov(a.url, this.bg.bind(this), this.Me.bind(this));
      else {
        var b = new XMLHttpRequest();
    ...
    else a.tileJSON ? this.bg(a.tileJSON) : qa(!1, 51);
  }
  u(Nw, Xv);
  k = Nw.prototype;
  k.Sn = function (a) {
  ...
  k.dk = function (a, b, c, d, e) {
    this.tileGrid
      ? ((b = this.tileGrid.we(a, b)),
        Ow(this.Lc(b[0], b[1], b[2], 1, this.c), a, c, d, e))
      : !0 === e
      ? setTimeout(function () {
          c.call(d, null);
        }, 0)
  ...
  k.bg = function (a) {
    ...
    if (g) {
      ...
      if (void 0 !== a.attribution) {
        b = void 0 !== d ? d : b.D();
        for (d = {}; f <= e; ++f) (g = f.toString()), (d[g] = [cc(c, b, f)]);
        this.ua([new nc({ html: a.attribution, tileRanges: d })]);
      }
      It(this, "ready");
    } else It(this, "error");
  ...
  k.getData = function (a) {
    ...
    var b =
      this.g[
        Math.floor(
          (1 - (a[1] - this.f[1]) / (this.f[3] - this.f[1])) * this.g.length
        )
      ];
    if ("string" !== typeof b) return null;
    b = b.charCodeAt(
      Math.floor(((a[0] - this.f[0]) / (this.f[2] - this.f[0])) * b.length)
    );
    93 <= b && b--;
    35 <= b && b--;
    b -= 32;
    a = null;
    b in this.j &&
      ((b = this.j[b]), this.c && b in this.c ? (a = this.c[b]) : (a = b));
    return a;
  };
  ...
  function Qw(a) {
    if (0 == a.state)
      if (((a.state = 1), a.v)) Ov(a.o, a.ei.bind(a), a.xe.bind(a));
      else {
        var b = new XMLHttpRequest();
  ...
  function Vw(a, b, c, d, e, f, g) {
    ...
    if (h) {
      ...
      g.BBOX = d.join(",");
      return mw(
        1 == h.length ? h[0] : h[Ca((b[1] << b[0]) + b[2], h.length)],
        g
      );
    }
  }
  ...
  function Ww(a, b, c, d, e) {
    ...
    this.j = d;
    this.g = null;
    this.f = { Ld: !1, wg: null, af: -1, xg: -1, vd: null };
    this.I = e;
    this.o = c;
  }
  u(Ww, vs);
  ...
  function Y(a) {
    function b(a) {
      ...
      return function (b) {
        if (b) {
          var c = { TileMatrix: e.j[b[0]], TileCol: b[1], TileRow: -b[2] - 1 };
          pb(c, g);
          b = a;
          return (b =
            "KVP" == d
    ...
    var d = (this.Y = void 0 !== a.requestEncoding ? a.requestEncoding : "KVP"),
      e = a.tileGrid,
      f = { layer: this.A, style: this.S, tilematrixset: this.o };
    "KVP" == d &&
      pb(f, {
        Service: "WMTS",
        Request: "GetTile",
  ...
  function bx(a) {
    ...
    f.reverse();
    b = [0, -b[1], b[0], 0];
    b = new $b({ extent: b, origin: eb(b), resolutions: f });
    (f = a.url) &&
      -1 == f.indexOf("{TileGroup}") &&
      (f += "{TileGroup}/{z}-{x}-{y}.jpg");
    f = Uv(f);
    f = Sv(
      f.map(function (a) {
        return function (b) {
  ...
  fx.prototype.add = function (a, b, c, d, e) {
    ...
    for (h = this.a.length; g < h; ++g)
      if (((f = this.a[g]), f.width >= b + this.b && f.height >= c + this.b))
        return (
          (h = { offsetX: f.x + this.b, offsetY: f.y + this.b, image: this.i }),
          (this.c[a] = h),
          d.call(e, this.f, f.x + this.b, f.y + this.b),
          (a = g),
          (b += this.b),
          (d = c + this.b),
  ...
  function ix(a, b, c, d, e, f, g) {
    ...
    for (p = h.length; m < p; ++m) {
      ...
      l ||
        m !== p - 1 ||
        (b
          ? ((l = Math.min(2 * a.c, a.f)), (a.c = l))
          : ((l = Math.min(2 * a.a, a.f)), (a.a = l)),
        (l = new fx(l, a.b)),
        h.push(l),
        ++p);
    }
  ...
  t("ol.loadingstrategy.tile", function (a) {
    return function (b, c) {
      ...
      for (d[1] = e.da; d[1] <= e.ba; ++d[1])
        for (d[2] = e.fa; d[2] <= e.ja; ++d[2]) f.push(a.Ta(d));
      return f;
    };
  });
  t("ol.Map", G);
  ...
  t("ol.Observable.unByKey", function (a) {
    if (Array.isArray(a)) for (var b = 0, c = a.length; b < c; ++b) rc(a[b]);
    else rc(a);
  });
  ...
  t("ol.source.WMTS.optionsFromCapabilities", function (a, b) {
    ...
    if ("OperationsMetadata" in a && "GetTile" in a.OperationsMetadata) {
      ...
      for (var n = 0, x = q.length; n < x; ++n) {
        ...
        "" === m && (m = y[0]);
        if ("KVP" === m) ea(y, "KVP") && v.push(q[n].href);
        else break;
      }
    }
    v.length ||
